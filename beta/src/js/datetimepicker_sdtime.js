...
//end Global variable
var seldatePrev="";
function NewCal_SDTIME(pCtrl,pFormat,pShowTime,pTimeMode,pScroller,pHideSeconds)
{
	...
	exDateTime=document.getElementById(pCtrl).value;
        seldateprev=exDateTime.split(" ");
	//alert("exdattime="+seldate[0]);
...
function GenCell(pValue,pHighLight,pColor)//Generate table cell with value
{
	...
	//PCellStr="<td "+vColor+" width="+CellWidth+" align='center'><font face='verdana' size='2'"+vHLstr1+"<a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+Cal.FormatDate(PValue)+"';"+vTimeStr+";window.close();\">"+PValue+"</a>"+vHLstr2+"</font></td>";
        PCellStr="<td "+vColor+" width="+CellWidth+" align='center'><font face='verdana' size='2'"+vHLstr1+"<a href=\"javascript:winMain.document.getElementById('"+Cal.Ctrl+"').value='"+seldateprev[0]+" ';"+vTimeStr+";window.close();\">"+PValue+"</a>"+vHLstr2+"</font></td>";
	return PCellStr;
}
