<?php
	...
	{*/
            ...
            if($user_type=="raw_milk" || $user_type=='substation' || $user_type=="plant_raw_milk" || $user_type=="hindalco_invoice" )
            {
                $query="UPDATE account SET password='$new_pass1',edit_id='$account_id',edit_date='$date' WHERE account_id=$account_id";
                //echo$query;
            }
            else
            {
                $query="UPDATE account SET password='$new_pass1',edit_id='$account_id',edit_date='$date' WHERE account_id=$local_account_id";
            }
	...
	//echo'<center><a href="#" onclick="javascript:setting_account_detail(\'src/php/setting_password_choose_account.php\',\'first_stage\');" class="menuitem">&nbsp;<b>Back</b></a></center>';
        ...
        {
            echo'<center><a href="#" onclick="javascript:setting_account_detail(\'src/php/setting_account_password_prev.php\',\'first_stage\');" class="menuitem">&nbsp;<b>Back</b></a></center>'; 
        }
