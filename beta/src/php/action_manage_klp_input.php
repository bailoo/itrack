			...
			foreach ($cellIterator as $cell) 
			{
				if (!is_null($cell)) 
				{
					...
					if($row>1)
					{
						...
						else if($vehicle_name_tmp!="" && $excel_icd_in_time=="" && trim($klp_input_values_local_1[1])=="" && trim($klp_input_values_local_1[2])=="" && trim($klp_input_values_local_1[3])!="select"  && trim($klp_input_values_local_1[4])=="" && trim($klp_input_values_local_1[5])=="" && trim($klp_input_values_local_1[6])=="" && trim($klp_input_values_local_1[7])=="")
						{
