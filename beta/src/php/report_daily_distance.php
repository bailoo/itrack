  ...
  echo'	
	...
	<fieldset class="text" style="width:10%;font-size: x-small">
		...
		<div align="center" style="height:75px;overflow:auto;">
			...
			for($i=1;$i<=31;$i++)
			{
			  //echo '<tr><td style="font-size: x-small"><input type="radio" name="days" value="'.$i.'" disabled="true">&nbsp;day'.$i.'</td></tr>';
			  echo '<tr>
						<td style="font-size: x-small">
							<input type="radio" name="days" value="'.$i.'">&nbsp;day'.$i.'
						</td>
					</tr>';
			}
    echo'</table>
	...
	<fieldset class="text" style="width:10%;font-size: x-small">
		<legend>
			...
			<table align="center" id="alldays">';
			  ...
			  echo '<tr>						
						<td style="font-size: x-small">
							<input type="checkbox" name="reportType" value="speed">
						</td>
						<td style="font-size: x-small">
							Speed
						</td>
		...
		<table border=0 cellspacing=0 cellpadding=3 align="center">						
			...
			<tr>
				<td align="center" colspan=2>
					<input type="button" class="btn btn-default btn-sm" onclick="javascript:action_report_daily_distance(this.form);" value="Enter">
						&nbsp;
