<?php
	...
	echo"<br>						  
        ...
        <table border=0 cellspacing=0 cellpadding=0 class='module_left_menu' align='center'>					
					...
					$data=getDetailAllStationPerson($account_id_local1,$station_type1,$DbConnection);						
					if(sizeof($data)>0)
					{  
						$k=0;
						foreach($data as $dt)
			...
			echo'</table>
				...
				<br>				
					<input type="button" id="enter_button" name="enter_button" Onclick="javascript:return action_manage_person_station(\'edit_dist_var\')" value="Update Station">&nbsp;<input type="reset" value="Cancel">
				<br><br><a href="javascript:show_option(\'manage\',\'visit\');" class="back_css">&nbsp;<b>Back</b></a>
				</center>
    ';
  ?>	