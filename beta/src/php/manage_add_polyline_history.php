<?php 
	...
	echo'
				<table border="0" class="manage_interface">
					...
					<tr>
						...
						<textarea  style="width:350px;height:60px" name="polyline_coord" id="polyline_coord" onclick="javascript:showCoordinateInterface(\'polyline\');"></textarea>
	...
	include_once('availability_message_polyline_div_history.php');
?>
