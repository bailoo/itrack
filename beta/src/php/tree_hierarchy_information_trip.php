<?php 
	...
	function radio_account_hierarchy($AccountNode)
	{
		...
		if($AccountNode->data->AccountTypeThirdParty!='1')
		{
			...
			echo"<td>&nbsp;                
				<INPUT TYPE='radio' name='manage_id' VALUE='$account_id_local' onclick='javascript:show_trip_vehicles($account_id_local)'><!--<a href='tree_account_detail.php?account_id_local=$account_id_local'>-->".$account_name."<!--</a>-->
			</td>";
			for($l=($k+1);$l<$MaxColumnNo;$l++)
			{
				echo"<td>&nbsp;".''."</td>";
