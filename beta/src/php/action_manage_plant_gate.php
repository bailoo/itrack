<?php  
	...
	{		
		...
		$account_id_gate = $_POST['plant_gate'];		
		//echo"vehiclesize=".$vehicle_size."<br>";
		//echo"account_id_substation=".$account_id_gate."<br>";
		...
		{		
			...
			$numrows = mysql_num_rows($result);
                        */
                       $numrows= getNumRowPlanGateAssingment($plant_id_main[$i],$account_id_gate,$DbConnection);
			...
			if($numrows==0)
			{
				...
				$result = mysql_query($query, $DbConnection);*/
                                $result =insertGateKeeperPlantAssingment($plant_id_main[$i],$account_id_gate,$account_id,$date,$DbConnection);
				if($result)
	...
	{	
		...
		{		
			...
			//echo $query;
			$result = mysql_query($query, $DbConnection);*/
                        $result = updateGateKeeperPlantAssingmnet($date,$plant_id_main[$i],$account_id_gate,$DbConnection);
	...
	echo'<center><a href="javascript:show_option(\'manage\',\'account_gate_plant\');" class="back_css">&nbsp;<b>Back</b></a></center>'; 
