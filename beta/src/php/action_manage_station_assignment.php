<?php
  ...
  $query="SELECT station_id FROM station WHERE user_account_id='$user_account_id' AND station_name='$geo_name'";
  $result=mysql_query($query,$DbConnection);        
  ...
  $query2="INSERT INTO station_assignment('station_id','vehicle_id','create_id','create_date') VALUES('$geo_id','$vid','$account_id','$date')";
  $result2=mysql_query($query2,$DbConnection);  

  if($result2){$message="Station Assigned To Vehicle Successfully";}
  else{$message="Unable to Assign Station to Vehicle";} 
 ...
 echo'<br><br><table border="0" align=center class="manage_interface" cellspacing="2" cellpadding="2"><tr><td colspan="3" align="center"><b>'.$message.'</b></td></tr></table>';
  ...
  if($DEBUG==1){echo "station name=".$geo_name." vname=".$vname." station_id=".$geo_id;} 
    	
  include_once('manage_station.php');
?> 
