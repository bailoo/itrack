<?php
 ...
 // $function_string='get_'.$vehicle_display_option1.'_vehicle_radio'; 		
  ...
  <table border=0 width = 100% cellspacing=2 cellpadding=0>
		<tr>
			<td height=10 class="report_heading" align="center">Polyline violation History</td>
		</tr>
	</table>    
		...
		<table border=0 cellspacing=0 cellpadding=3 align="center">						
			...
			<tr>
				<td align="center" colspan=2>
					<input type="button" onclick="javascript:action_polyline_violation_history(this.form);" value="Enter">
						&nbsp;
