        ...
        echo" <form name='manage1'>
            <ol class='breadcrumb' style='background-color:#f7fafc;padding:1px 15px;border-radius:0px'>
                ...
                <li class='active'><b>Ployline(Route)</b>&nbsp;&nbsp;&nbsp;
                 ...
                 ";
                echo'
                   <a onclick="'.$js_function_name.'(\'src/php/manage_add_polyline.php\');" class="btn btn-default" data-toggle="tab" style="padding: 1px 12px;">
                   ...
                   <a onclick="'.$js_function_name.'(\'src/php/manage_edit_polyline_prev.php\');" class="btn btn-default" data-toggle="tab" style="padding: 1px 12px;">
