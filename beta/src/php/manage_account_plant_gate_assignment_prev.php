<?php 
	...
	<center>
		...
		{	
			...
			echo '<strong>Select Gate User &nbsp;:&nbsp;</strong> <select name="plant_gate" id="plant_gate">';
			$dataAU=getAccountIDGateUserID($DbConnection);
			...
			echo '<br><br><input type="button" id="enter_button" name="enter_button" Onclick="javascript:return action_manage_plant_gatekeeper(manage1,\'assign\')" value="Assign"> <!--action_manage_vehicle_substation-->'; 
			echo '</div>';
		}
