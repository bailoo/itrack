<?php	
	...
	echo "search_vehicle_raw_milk##".$box."##";
				...
				foreach ($array as $a ) 
				{
					...
					{					
						...
						{						
							...
							echo"<tr id=\"word".$country."\" onmouseover=\"highlight(1,'".$country."');\" onmouseout=\"highlight(0,'".$country."');\" onClick=\"display_raw_milk_vehicle('".$common_value."');\">
									\n						
