<?php
	...
	<center>
			<table border=0 width = 100% cellspacing=2 cellpadding=0>
				<tr>
					<td height=10 class="report_heading" align="center">Vehicle Reverse violation</td>
				</tr>
			</table>			
			...
			<tr>
				...
				<td>
					<table>
						...
						<!--<input type="text" id="date1" name="start_date" value="2014/07/05 00:00:00" size="10" maxlength="19">-->
						...
						<!--<input type="text" id="date2" name="end_date" value="2014/07/05 23:59:59" size="10" maxlength="19">-->
		...
		<table border=0 cellspacing=0 cellpadding=3 align="center">						
			...
			<tr>
				<td align="center" colspan=2>
					<input type="button" onclick="javascript:action_alert_vehicle_reverse(this.form);" value="Enter">
						&nbsp;
