				...
				<div style="overflow: auto;height: 300px; width: 620px;">';
					...
					{								              
						if(($i===0) || (($i>0) && ($finalVSerialArr[$i-1] != $finalVSerialArr[$i])) )
						{
							...
							$j++;
							$sno = 1;					
							$csvtitle1="Battery Voltage Report :- ".$finalVNameArr[$i]." (".$finalVSerialArr[$i]." )  DateTime :".$date1." - ".$date2." )";
							...
							echo'<table align="center">
								...
								echo'<td class="text" align="left">
										'.round($finalbatteryVoltageArr[$i],2).'
									</td>';
									echo"<input TYPE=\"hidden\" VALUE=\"$finalbatteryVoltageArr[$i]\" NAME=\"temp[$j][$k][Suply Voltage]\">";
									$csv_string = $csv_string.','.$finalbatteryVoltageArr[$i];
							echo'</tr>';
