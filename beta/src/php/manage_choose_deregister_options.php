<?php
  ...
  ?>
	<br>
	<input type='hidden' id='file_name' value='manage_device_vehicle_deassignment.php'>
	<table align="center" border="0" class="module_left_menu">   
          <tr>
              <td><input type="radio" name="vehicle_details_option" id="group" onclick="javascript:select_manage_deregister_options('group')">&nbsp;Select By Group</td>
			  <td><input type="radio" name="vehicle_details_option" id="user" onclick="javascript:select_manage_deregister_options('user')">&nbsp;Select By User</td>
              <td><input type="radio" name="vehicle_details_option" id="user_type" onclick="javascript:select_manage_deregister_options('user_type')">&nbsp;Select By User Type</td>
              <td><input type="radio" name="vehicle_details_option" id="vehicle_tag" onclick="javascript:select_manage_deregister_options('vehicle_tag')">&nbsp;Select By Vehicle Tag</td>
              <td><input type="radio" name="vehicle_details_option" id="vehicle_type" onclick="javascript:select_manage_degregister_options('vehicle_type')">&nbsp;Select By Vehicle Type</td>
