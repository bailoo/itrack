...
get_speed_detail_xml($vserial, $year, $month, $day, $xmin, $xmax, $ymin, $ymax, $height, $width);
  
function get_speed_detail_xml($vserial, $year, $month, $day, $xmin, $xmax, $ymin, $ymax, $height, $width)
{
  global $vname;
...
///////// PLOT GRAPH  ////////////////   
  ...
  */
  ...
  $graph->yaxis->title->Set("Speed(km/hr)");
  // Use built in font
