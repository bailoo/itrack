<?php
	...
	echo' 
  	...
  	<table border=0 width = 100% cellspacing=2 cellpadding=0>
  		<tr>
  			<td height=10 class="report_heading" align="center">Fuel Lead Report</td>
  		</tr>
  	</table>
	...
	echo'<fieldset class="report_fieldset">
		...
		<br>				
			...
			<table border=0 align="center">						
				<tr>
					<td class="text" align="center"><input type="button" onclick="javascript:action_report_fuel_lead(this.form);" value="Show Report"></td>
				</tr>
			</table>			
	</form> 
