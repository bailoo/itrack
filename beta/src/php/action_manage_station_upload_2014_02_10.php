    ...
    //***********************************************************
      ...
      for($x=0;$x<sizeof($customer_no);$x++)
      {
        ...
        if($max_no==""){$max_no=1;}
    		...
    		$query_string1="INSERT INTO station(user_account_id,station_id,customer_no,station_name,station_coord,type,status,create_id,create_date,remark) VALUES";
        ...
        for($i=0;$i<$account_size;$i++)
    		{
    			...
    			if($i==$account_size-1)
    			{
    				$query_string2.="('$local_account_ids[$i]','$max_no','$customer_no[$x]','$station_name[$x]','$station_coord[$x]','$type','1','$account_id','$date','$remarks[$x]');";
    			}
    			else
    			{
    				$query_string2.="('$local_account_ids[$i]','$max_no','$customer_no[$x]','$station_name[$x]','$station_coord[$x]','$type','1','$account_id','$date','$remarks[$x]'),";
