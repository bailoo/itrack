...
function mapOnly(vName,tripStartDate,tripEndDate)
{
//alert("vName="+vName);
document.getElementById("clickVehicle").value=vName;
document.getElementById("tripStartDate").value=tripStartDate;
document.getElementById("tripEndDate").value=tripEndDate;
...
echo'<form name="newMapOnly" method="POST" action="live_NMap.php" target="_blank">
<input type="hidden" id="clickVehicle" name="clickVehicle">
<input type="hidden" id="tripStartDate" name="tripStartDate">
<input type="hidden" id="tripEndDate" name="tripEndDate">
    <font style="font-size:12px;color:#008000"> Vehicle Running Status to Plant on '.$date.'</font>
	<table width="100%" border="1" rules="all">
	  <tr class="style_v1">
		...
		<td bgcolor="#CCCCCC">Current Speed</td>
		<td bgcolor="#CCCCCC">Location</td>
		<td bgcolor="#CCCCCC">Dispatch Time</td>
		<td bgcolor="#CCCCCC">Target Time</td>		
		<td bgcolor="#CCCCCC">To Plant</td>
...
for($i=0;$i<sizeof($vehiclename_arr_last);$i++)
{
		...
		else if($vehilce_status_arr[$i]=="Running")
		{
			...
			<span class="style_v7">
				<!--
				<a href="#" onclick="javascript:mapOnly(\''.$vserial_arr_last[$i].'\',\''.$trip_startdate.'\',\''.$datetime_arr_last[$i].'\')">
		...
		echo '<td><span class="style_v9">'.$dispatch_time_arr[$i].'</span></td>';
		echo '<td><span class="style_v9">'.$target_time_arr[$i].'</span></td>';		
		echo '<td><span class="style_v9">'.$plant_number_arr[$i].'</span></td>';
		...
		else if($vehilce_status_arr[$i]=="Stopped")
		{
			...
			$halt_time=strtotime($current_datetime_new)-strtotime($last_halt_time_arr_last[$i]);			
