<?php 
  ...
  {	
		...
		echo'<tr> 
				<td align="left">&nbsp;<INPUT TYPE="checkbox"  name="live_vehicles[]" VALUE="'.$vehicle_imei.'#NA"></td>
  ...
  {      
      ...
      { 
        ...
        foreach($vehicle_name_arr as $vehicle)
        {
          ...
          <tr>
            <td align="left">
				<span id="'.$vchk.'"><INPUT TYPE="checkbox"  name="live_vehicles[]" VALUE="'.$imei_arr[$vehicle].'"></span>			
              <!--<span id="'.$vchk.'"><INPUT TYPE="checkbox"  name="live_vehicles[]" VALUE="'.$imei_arr[$vehicle].'#NA"></span>-->
