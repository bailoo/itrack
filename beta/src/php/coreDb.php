...
function getAccountPolyline($accId,$DbConnection)
{
...
//========================
function updateInvoiceMdrmApproved($plant_serials,$date,$invoice_material_serials,$unload_estimatetime_serials,$unload_estimatedatetime_serials,$fat_per_ft_serials,$snf_per_ft_serials,$testing_status_serials,$qty_ct_serials,$temp_ct_serials,$acidity_ct_serials,$mbrt_min_ct_serials,$mbrt_br_ct_serials,$mbrt_rm_ct_serials,$protien_per_ct_serials,$sodium_ct_serials,$fat_per_rt_serials,$snf_per_rt_serials,$adultration_ct_serials,$otheradultration_ct_serials,$date,$sno,$DbConnection)
{
    $query_update = "UPDATE invoice_mdrm SET plant='$plant_serials',plant_acceptance_time='$date',invoice_material='$invoice_material_serials',unload_estimated_time='$unload_estimatetime_serials',unload_estimated_datetime='$unload_estimatedatetime_serials',
									fat_per_ft='$fat_per_ft_serials',snf_per_ft='$snf_per_ft_serials',testing_status='$testing_status_serials',qty_ct='$qty_ct_serials',
						temp_ct='$temp_ct_serials',acidity_ct='$acidity_ct_serials',mbrt_min_ct='$mbrt_min_ct_serials',mbrt_br_ct='$mbrt_br_ct_serials',
						mbrt_rm_ct='$mbrt_rm_ct_serials',protien_per_ct='$protien_per_ct_serials',sodium_ct='$sodium_ct_serials',fat_per_rt='$fat_per_rt_serials',
						snf_per_rt='$snf_per_rt_serials' , adultration_ct='$adultration_ct_serials' , otheradultration_ct='$otheradultration_ct_serials' ,edit_date='$date' WHERE sno='$sno'";
...
//=============
function updateInvoiceMdrmNoApproved_flag_add($plant_serials,$invoice_material_serials,$unload_estimatetime_serials,$unload_estimatedatetime_serials,$fat_per_ft_serials,$snf_per_ft_serials,$testing_status_serials,$qty_ct_serials,$temp_ct_serials,$acidity_ct_serials,$mbrt_min_ct_serials,$mbrt_br_ct_serials,$mbrt_rm_ct_serials,$protien_per_ct_serials,$sodium_ct_serials,$fat_per_rt_serials,$snf_per_rt_serials,$adultration_ct_serials,$otheradultration_ct_serials,$date,$sno,$DbConnection)
{
     $query_update = "UPDATE invoice_mdrm SET plant='$plant_serials',invoice_material='$invoice_material_serials',unload_estimated_time='$unload_estimatetime_serials',unload_estimated_datetime='$unload_estimatedatetime_serials',
									fat_per_ft='$fat_per_ft_serials',snf_per_ft='$snf_per_ft_serials',testing_status='$testing_status_serials',qty_ct='$qty_ct_serials',
						temp_ct='$temp_ct_serials',acidity_ct='$acidity_ct_serials',mbrt_min_ct='$mbrt_min_ct_serials',mbrt_br_ct='$mbrt_br_ct_serials',
						mbrt_rm_ct='$mbrt_rm_ct_serials',protien_per_ct='$protien_per_ct_serials',sodium_ct='$sodium_ct_serials',fat_per_rt='$fat_per_rt_serials',
...
//======================
function updateInvoiceMdrmApprovedUnload($plant_serials,$date,$invoice_material_serials,$unload_estimatetime_serials,$unload_estimatedatetime_serials,$unload_accepttime_serials,$fat_per_ft_serials,$snf_per_ft_serials,$testing_status_serials,$qty_ct_serials,$temp_ct_serials,$acidity_ct_serials,$mbrt_min_ct_serials,$mbrt_br_ct_serials,$mbrt_rm_ct_serials,$protien_per_ct_serials,$sodium_ct_serials,$fat_per_rt_serials,$snf_per_rt_serials,$adultration_ct_serials,$otheradultration_ct_serials,$sno,$DbConnection)
{
    $query_update = "UPDATE invoice_mdrm SET plant='$plant_serials',plant_acceptance_time='$date',invoice_material='$invoice_material_serials',unload_estimated_time='$unload_estimatetime_serials',unload_estimated_datetime='$unload_estimatedatetime_serials',unload_accept_time='$unload_accepttime_serials' ,
									fat_per_ft='$fat_per_ft_serials',snf_per_ft='$snf_per_ft_serials',testing_status='$testing_status_serials',qty_ct='$qty_ct_serials',
						temp_ct='$temp_ct_serials',acidity_ct='$acidity_ct_serials',mbrt_min_ct='$mbrt_min_ct_serials',mbrt_br_ct='$mbrt_br_ct_serials',
						mbrt_rm_ct='$mbrt_rm_ct_serials',protien_per_ct='$protien_per_ct_serials',sodium_ct='$sodium_ct_serials',fat_per_rt='$fat_per_rt_serials',
						snf_per_rt='$snf_per_rt_serials',adultration_ct='$adultration_ct_serials' , otheradultration_ct='$otheradultration_ct_serials' ,edit_date='$date' WHERE sno='$sno'";
...
//=============
function updateInvoiceMdrmNoApprovedUnload_flag_add($plant_serials,$invoice_material_serials,$unload_estimatetime_serials,$unload_estimatedatetime_serials,$unload_accepttime_serials,$fat_per_ft_serials,$snf_per_ft_serials,$testing_status_serials,$qty_ct_serials,$temp_ct_serials,$acidity_ct_serials,$mbrt_min_ct_serials,$mbrt_br_ct_serials,$mbrt_rm_ct_serials,$protien_per_ct_serials,$sodium_ct_serials,$fat_per_rt_serials,$snf_per_rt_serials,$adultration_ct_serials,$otheradultration_ct_serials,$sno,$date,$DbConnection)
{
    $query_update = "UPDATE invoice_mdrm SET plant='$plant_serials',invoice_material='$invoice_material_serials',unload_estimated_time='$unload_estimatetime_serials',unload_estimated_datetime='$unload_estimatedatetime_serials',unload_accept_time='$unload_accepttime_serials' ,
									fat_per_ft='$fat_per_ft_serials',snf_per_ft='$snf_per_ft_serials',testing_status='$testing_status_serials',qty_ct='$qty_ct_serials',
						temp_ct='$temp_ct_serials',acidity_ct='$acidity_ct_serials',mbrt_min_ct='$mbrt_min_ct_serials',mbrt_br_ct='$mbrt_br_ct_serials',
						mbrt_rm_ct='$mbrt_rm_ct_serials',protien_per_ct='$protien_per_ct_serials',sodium_ct='$sodium_ct_serials',fat_per_rt='$fat_per_rt_serials',
						snf_per_rt='$snf_per_rt_serials',adultration_ct='$adultration_ct_serials' , otheradultration_ct='$otheradultration_ct_serials' ,edit_date='$date',edit_date_plant_first='$date' WHERE sno='$sno'";
...
/*************************************************Third Party Vehicle Assignment**********************************************/
 function getVehicleIdThirdPartyVehicleAssign($account_id,$post_destination_account1,$DbConnection)
 {
	...
	//$querydesaid="SELECT vehicle_id from third_party_vehicle_assignment WHERE admin_account_id='$account_id' AND third_party_account_id='$post_destination_account1' and status=1";	
	//echo $querydesaid;
	$resultdesaid=mysql_query($querydesaid,$DbConnection);
	while($row=mysql_fetch_object($resultdesaid))
	{
...
function getHierarchythirdpartyaccountassignmentaccountid($accId,$DbConnection)
{
	$querySourceAccount = "SELECT distinct admin_account_id FROM third_party_account_assignment WHERE third_party_account_id='$accId' AND status=1";
	...
	{
		while($row=mysql_fetch_object($resultSourceAccount))
		{									
			/*$location_id=$row->location_id;
			$location_name=$row->location_name;*/
			$data[]=array('admin_account_id'=>$row->admin_account_id);	
		}
	  return $data;
	}
	else
...
function getHierarchyAccountDetailNumRows($accountid,$DbConnection)
{
	$query="SELECT * FROM account_detail USE INDEX (ad_account_id) WHERE  account_id='$accountid'";	
	//echo $query;
	$result=mysql_query($query,$DbConnection);
	...
	if($num_rows>0)
	{
		...
		{									
			...
			$data[]=array('name_local'=>$name_local,'admin_id_local'=>$admin_id_local,'create_id_local'=>$create_id_local,'vehicle_group_id_local'=>$vehicle_group_id_local,'account_admin_id'=>$account_admin_id);	
		}
	  return $data;
	}
	else
...
function getHierarchythirdpartyaccountassignment($admin_account_id_destination,$account_id,$DbConnection)
{
	...
	{		
		...
		{
			$vehicle_id=$rowThirdParty ->vehicle_id;					
			//$vehicle_date_from_third_party[$vehicle_id[$j]]=$rowThirdParty ->create_date;	
			$create_date=$rowThirdParty ->create_date;					
			$data[]=array('vehicle_id'=>$vehicle_id,'create_date'=>$create_date);		
		}
		return $data;
	}
	else
...
function uidgidAccount($account_id_local,$DbConnection)
{
	...
	$num_rows=mysql_num_rows($resultuid);
	if($num_rows>0)
	{
...
function getInvoiceMDRM($condition,$startdate,$enddate,$conditionStr,$order,$user_type,$DbConnection)
{
	if($user_type=="plant_raw_milk")
	{
                ...
                else if($condition=='unloadaccepttime') //$condition="invoicestatus_alldataNoDate";$orderA="1";$user_type="admin";$conditionStr=""; getInvoiceMDRM($condition,$startdate,$enddate,$conditionStr,$orderA,$user_type);
		{
			$query = "SELECT invoice_mdrm.*,account.user_id as uid,account_detail.name as nme FROM invoice_mdrm,account,account_detail USE INDEX(ad_account_id) WHERE 
							account.account_id=account_detail.account_id AND invoice_mdrm.parent_account_id=account_detail.account_id AND invoice_mdrm.status=1 AND account.status=1
							AND ($plant_in) AND invoice_mdrm.invoice_status='$order' AND invoice_mdrm.unload_accept_time BETWEEN '$startdate' AND '$enddate'";
							//echo"Test";  
		}
