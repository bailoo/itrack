...
include_once($abspath."/daily_report/motherdairy/delhi/get_master_detail.php");
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_MORNING_(MOTHER_DELHI)_'.$current_date."_".$inc_serial."#mor";
...
*/		
	...
	$to = 'Shreya.Shinde@motherdairy.com,Vijay.Singh@motherdairy.com,Ravindra.Negi@motherdairy.com,teetu.kumar@motherdairy.com,call1.center@motherdairy.com,ashish.sawhney@motherdairy.com,Rahul.tiwari@motherdairy.com,Shiv.sharma@motherdairy.com,Logistic.Ppg@motherdairy.com,ashish@iembsys.co.in';
	$subject = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_DELHI)_'.$current_date;
	$message = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_DELHI)_'.$current_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>"; 
	$random_hash = md5(date('r', time()));  
	$headers = "From: support@iembsys.co.in\r\n";
	//$headers .= "Cc: rizwan@iembsys.com";  
	$headers .= "Cc: rizwan@iembsys.com,jyoti.jaiswal@iembsys.com,support1@iembsys.com,jyoti.jaiswal@iembsys.com,support2@iembsys.com";
