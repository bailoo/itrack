...
$td_cnt=0;
$type_tag;
$common_id_local=$_POST['common_id'];		$group_status1=$_POST['group_status'];	$report_type_title=$_POST['report_type1'];
...
if($report_type_title=="Trip Report" || $report_type_title=="Vehicle Movement Report" || $report_type_title=="Trip Summary Report") //////coming from session
{
  ...
  echo'<input type="hidden" id="report_type_title" value="'.$report_type_title.'">';
	...
	//date_default_timezone_set('Asia/Calcutta');		$current_date = date('Y-m-d');		
/*else
{
...
{	
  ...
  //echo "<br>xml_file=". $xml_file;	
    ...
    //echo "<br>exists";
    //echo "td_cnt=".$td_cnt."<br>";
	   echo'<td align="left">&nbsp;<INPUT TYPE="radio"  name="vehicleserial" VALUE="'.$person_imei.'"></td>
