...
<?php	
	...
	$backdate=strtotime($date)-(15*60);
	$newDate = date("Y-m-d H:i:s", $backdate);
	...
	$query_validate="SELECT  device_imei_no,vehicle_name,from_place,to_place,consignee_name FROM consignment_info where docket_no='$docket_no'  AND status=1";
