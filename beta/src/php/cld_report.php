<?php
	...
	include_once("read_filtered_xml_crd.php");      // INCLUDE READ FILTERED XML, PARAMETER PASSED FOR LAST DATA
	...
	//echo $xml_path."<br>";
	read_cld_xml($xml_path, &$datetime, &$vehicleserial, &$vehiclename, &$vehiclenumber, &$last_halt_time, &$lat, &$lng, &$vehicletype, &$speed,  &$io1, &$io2, &$io3, &$io4, &$io5, &$io6, &$io7, &$io8); 
		...
		<br>			
			...
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" width="100%" align="center">
				<TR>
					<TD>						   
						<?php
							/*echo'<table border=0 width = 100% cellspacing=2 cellpadding=0 align="center">
										<tr>
											<td width="8%"> &nbsp;</td> 
