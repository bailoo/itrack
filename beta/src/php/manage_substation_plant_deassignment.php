...
echo "deassign_substation_plant##"; 
...
$common_id1 = $_POST['local_account_id'];
  ...
  if($DEBUG==1){echo "query=".$query;}
	...
	<center>
		...
		echo '<br><br><input type="button" id="enter_button" name="enter_button" Onclick="javascript:return action_manage_plant_substation(manage1,\'deassign\')" value="DeAssign">';
		echo '</div>
