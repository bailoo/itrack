...
class class_polyline_edge{
	...
	function get_polyline($polyline_coord,$chk_latlng_array,$data_date_array){
		$flag_edge=0;		
		$data_value=array();
		$d=0;
		foreach($chk_latlng_array as $chk_latlng)
		{
			$data_value[]=$this->get_perpendicular_distance($polyline_coord,$chk_latlng,str_replace(':','-',$data_date_array[$d]));
			$d++;
		}
		//print_r($data_value);
	...
	public function get_perpendicular_distance($polyline_coord,$chk_latlng,$data_date){
