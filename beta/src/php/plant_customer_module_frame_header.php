<?php      
    ...
    $user_name=$row->name;
    $v_align='left';
    /*echo "<br>Size=".$session_user_substation;
    for($i=0;$i<$size_utype_session;$i++) {
        echo "F=".$size_utype_session[$i]."<br>";
        if($size_utype_session[$i]=='customer'){
            $customer_flag = true;
        }
    }*/
    $customer_flag = false;
    if($session_user_substation=="customer") {
        $customer_flag = true;
    }
    //echo "CF=".$customer_flag;
	...
	echo "<table border='0' width='100%' cellpadding='0' cellspacing='0' height='100%' class='frame_header_table'>  
			<tr>
				...
				<td align='left' width='17%'><strong>&nbsp;[&nbsp;Customer Plant On Map&nbsp;]&nbsp;</strong></td>";
			
			//if($interface=="home.php" || $interface=="live.php")
			//if($interface=="home.php" || $interface=="live.php")
			if(($interface=="home.php" || $interface=="live.php") && !$customer_flag)
			{
					...
					<table class="frame_header_table" border="0" cellspacing=0 cellpadding=0>
						<tr>';	           
							...
							echo'<td>
								...
								if($session_user_substation=="transporter")
                                                                {
                                                                    echo'<td>
                                                                            <!--'.$set_nbsp.'|'.$set_nbsp.'-->
									</td>
									...
									<td '.$v_align.'>';	
										if($interface == "my_organisation.php")
										{
											echo '<b class="hs1">My Organisation</b>';
										} 
										else
										{ 
											echo '<a href="my_organisation.htm" class="hs2">My Organisation</a>';
										}
								echo'</td>';
                                                                }
