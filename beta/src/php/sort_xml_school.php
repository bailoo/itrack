  ...
  if($fexist)
  {
      ...
      if($format == 2)
      {
         ...
         for($y=0;$y<$i;$y++)
         {
            ...
            $linetowrite =  "\n"."<marker ".$vehicleserial[$y]." ".$lat[$y]." ".$lng[$y]." ".$alt[$y]." ".$speed[$y]." ".$datetime[$y]." ".$fuel[$y]." ".$vehicletype[$y]." ".$rfid[$y]."/>";
            fwrite($fh, $linetowrite);  
      ...
      if($format == 1)
      {
         ...
         for($y=0;$y<$i;$y++)
         {
            ...
            $linetowrite =  "\n"."<marker ".$vehicleserial[$y]." ".$lat[$y]." ".$lng[$y]." ".$alt[$y]." ".$speed[$y]." ".$datetime[$y]." ".$fuel[$y]." ".$vehicletype[$y]." ".$fix[$y]." ".$rfid[$y]."/>";
