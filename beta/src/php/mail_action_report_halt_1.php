										...
										{											
											...
											else
											{
												...
												*/
												...
												if($place =="")
												{
													get_report_location($lat_ref,$lng_ref,&$place1);
													//echo "<br>PL1=".$placename1;
													$place1 = preg_replace('/भारत गणराज्य/', '' , $place1);
												...
												if($substr_count == 0)
												{											
													$csv_string_halt = $csv_string_halt.$sno.','.$place.','.$arrivale_time.','.$depature_time.','.$hrs_min;
													$substr_count =1;  
												}
												else
												{
