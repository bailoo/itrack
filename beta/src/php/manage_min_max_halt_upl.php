<?php
	...
	$query="SELECT * FROM schedule_location_upl WHERE account_id='$account_id_local1' AND status='1'";
	//echo "query=".$query."<br>";
	...
	{
		echo"<tr>
				<td style='display:none'><b>Min Halt Time</b></td>
				<td style='display:none'><b>Max Halt Time</b></td>
				<td><b>Location</b></td>
			</tr>
			<tr>
