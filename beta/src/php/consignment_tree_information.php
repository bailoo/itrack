<?php
	...
	function radio_account_hierarchy($AccountNode)
	{
		...
		echo"<td>&nbsp;                
			<INPUT TYPE='radio' name='manage_id' VALUE='$account_id_local,$account_name' onclick='javascript:show_consignment_vehicle(this.value);'><!--<a href='tree_account_detail.php?account_id_local=$account_id_local'>-->".$account_name."<!--</a>-->
		</td>";
