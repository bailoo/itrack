<?php
	...
	$js_function_name = "setting_show_file";    // FUNCTION NAME  
	echo '<center>
			<form name="setting">
					...
					<legend><strong>Student</strong></legend>
						<table border="0" class="manage_interface" align="center">
							<tr>
								...
								-->
								<input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/setting_edit_student_prev.php\')"/> Edit &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
									<!--
