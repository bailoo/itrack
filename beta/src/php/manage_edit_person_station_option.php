				...
				<fieldset class="manage_fieldset3">
					<legend><strong>Edit Option</strong></legend>
						<table border="0" class="manage_interface" align="center">
							<tr>
								<td>
							     <input type="radio" name="new_exist" value="new" onclick="'.$js_function_name.'(\'src/php/manage_edit_delete_person_station.php?account_id_local='.$account_id_local.'\')"/> Edit Detail &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
									<input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/manage_edit_person_station_distance_variable_prev.php?account_id_local='.$account_id_local.'\')"/> Edit Distance Variable&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
								</td>
							</tr>
						</table>     
				</fieldset>	
