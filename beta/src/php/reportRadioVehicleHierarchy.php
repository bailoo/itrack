...
{	
  ...
  else
  {
     //echo "<br>2";
     echo'<td align="left">&nbsp;<INPUT TYPE="checkbox"  name="vehicleserial[]" VALUE="'.$vehicle_imei.'"></td>
		 <td class=\'text\'>&nbsp;<A HREF="#" style="text-decoration:none;" onclick="main_vehicle_information('.$vehicle_id.')"><font color="'.$vcolor3.'">'.$vehicle_name.'&nbsp;';if($type_tag==1) {echo'('.$option_name.')';} echo'</font></A></td>';
  }
