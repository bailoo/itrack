<?php 
	...
	echo "<br>
			...
			echo"</tr>";	
				...
				echo "</table>";
				echo'<br><center> <input type="button" name="submit" value="Enter" onclick="javascript:manage_io_validation()"></center></form>';
				echo'<br><center><a href="javascript:show_option(\'manage\',\'io_assignment\');" class="back_css">&nbsp;<b>Back</b></a></center>';  
