<?php
	...
	$action_name1=$_POST['action_name1'];	
	//echo "action_name=".$action_name1."<br>manage_id=".$manage_id1."action_no=".$action_no1;
	
	if($action_name1=="device")
	{
		$function_name="action_manage_device";
		$query="SELECT account_id from device_assignment where device_imei_no='$manage_id1' and status=1";
	}
	else if($action_name1=="vehicle")
	{
		$function_name="action_manage_vehicle";
		$query="SELECT account_id from vehicle_grouping where vehicle_id='$manage_id1' and status=1";
	}
	else if($action_name1=="student")
	{
		$function_name="action_manage_student1";
		$query="SELECT account_id from student_grouping where student_id='$manage_id1' and status=1";
	}	
	...
	{
		$accountid[$acc_size]=$row->account_id;
		$acc_size++;
	}	
