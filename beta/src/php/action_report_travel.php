                ...
                for($obi=0;$obi<$prevSortedSize;$obi++)
                {
                    ...
                    if($DataValid==1)
                    {
                        ...
                        {                                
                            ...
                            $lnglast =  $lng;  
                            $max_speed	=0.0;
                            $date_secs1 = strtotime($datetime_S);					
                            //echo "<br>DateSec1 before=".$date_secs1." time_int=".$interval;
                            $date_secs1 = (double)($date_secs1 + $datetime_threshold);
                        }           	              	
                        else
                        {           
                            $lat_E = $lat;
                            ...
                            $datetime_E = $datetime; 
                            $date_secs2 = strtotime($datetime_E);
                            ...
                            //echo "halt flag0=".$haltFlag."dateime0=".$datetime_E . " -- " . $lat_E .",". $lng_E . "\tDelta Distance0 = " . $distance_incriment . "\tTotal Distance = " . $distance_total . "\tmp_speed Distance0 = " . $tmp_speed . "\tmp_speed0= " . $tmp_speed . "\tmp_speed10= " . $tmp_speed1 . "\tmp_time_diff= " . $tmp_time_diff . "\tmp_time_diff10= " . $tmp_time_diff1 . "<br><br>";               
                            if($tmp_speed<300.0 && $tmp_speed1<300.0 && $distance_incriment>0.1 && $tmp_time_diff>0.0 && $tmp_time_diff1>0)
                            {
                                ...
                                //echo "halt flag1=".$haltFlag." datetimestart1=".$datetime_S." dateTime1=".$datetime_E . " -- " . $lat_E .",". $lng_E . "\tDelta Distance1 = " . $distance_incriment . "\tTotal Distance1= " . $distance_total . "<br><br>";
                            }
                            ...
                            //if(($distance_total>$distance_error) && ($datetime_diff > $datetime_threshold) && ($haltFlag==False))
                            //echo "datetime_diff=".$datetime_diff."datetimeThreshold=".$datetime_threshold."<br><br>";
                            if(($datetime_diff > $datetime_threshold) && ($haltFlag==False))
                            {
                               // echo "maxspeed=".$max_speed."<br>";
                                ...
                                $date_secs1 = strtotime($datetime_E);
                                ...
                                <table align="center">
                                    <tr>
                                        <td class="text" align="center">
                                            <b>
                                                <font color="red">
                                                    No Travel Report Found For Selected Vehicles
                                                </font>
                                            </b>
                                        </td>
                                    </tr>
