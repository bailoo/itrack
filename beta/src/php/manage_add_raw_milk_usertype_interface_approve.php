	...
	<td colspan="17"> <!--20-->
		<table width=1175px >
			<tr>
				...
				<td><input type="text" name="lrno" id="lrno:0" value="" style="width:70px;" placeholder="LRNO" onkeyup="javascript:alphanumeric_ucase(this.value,this.id);" onblur="javascript:invoice_lorry_unique_pre(this.value,this.id);" /></td> <!--onblur="javascript:invoice_lorry_unique_pre(this.value,this.id);" -->
