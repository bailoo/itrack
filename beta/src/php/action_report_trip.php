...
if($trip_old==1)
{
	echo 'ShowNewTripFormat##
	<table border="0" class="module_left_menu" width="100%">
          <tr>
            <td class="manage_interfarce" align="right" colspan="7"><a href="#" onclick="javascript:closeShowNewTripFormat()" class="hs3"><img src="images/close.png" type="image" style="border-style:none;"></a>&nbsp;&nbsp;</td> 													
    	  </tr>
	</table>';
}
...
{	
  echo'<table border=0 width="100%"cellspacing=0 cellpadding=0><tr><td align="center"><div style="width:800px;overflow:auto" align="center"><table border=1 width="80%" rules=all bordercolor="#689FFF" align="center" cellspacing=0 cellpadding=3>';
	...
	if($num_results1)
	{
      ...
      //if($DEBUG) echo "<br>Q2=".$Query2."<br>";
			$Result2 = mysql_query($Query2, $DbConnection);
			$num_results2 = mysql_num_rows($Result2);
			//if($DEBUG) echo "<br>numQ2=".$num_results2."<br>";
