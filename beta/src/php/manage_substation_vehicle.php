				...
				<table border="0" class="manage_interface" align="center">
					<tr>
						<td>
							...
							<input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/manage_substation_vehicle_assignment_prev.php\')"/> Assignment &nbsp;&nbsp;&nbsp;
							<input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/manage_substation_vehicle_deassignment_prev.php\')"/> De-Assignment
						</td>
					</tr>
				</table>     
		</fieldset>
