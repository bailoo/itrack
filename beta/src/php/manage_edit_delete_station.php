	...
	<table border="0" class="manage_interface" cellspacing="2" cellpadding="2">
		<tr>
			...
			<td>
				...
				//echo $query;
				$data=getDetailAllStation($account_id_local,$station_type1,$DbConnection); /// for debug
				//print_r($data);
				
				?>
				<select name="station_id" id="station_id" onchange="javascript:show_station_coord(manage1);">
				...
				<div id="coord_area" style="display:none">
					<table class="manage_interface">                   					         
						...
						<tr>                          
							...
							<input type="text" name="station_name" id="station_name" onkeyup="manage_availability(this.value, 'station')">
							</td>                                
						</tr> 
		...
		<tr>
			<td colspan="3" align="center">
				<input type="button" value="Update" id="enter_button" onclick="javascript:return action_manage_station('edit')"/>&nbsp;
