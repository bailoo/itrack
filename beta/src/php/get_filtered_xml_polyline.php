...
$point_type = $_REQUEST['point_type'];
...
if ($home_report_type == "map_report" || $home_report_type == "play_report") {
    ...
    if ($report_type == "Vehicle") {
        ...
        for ($di = 0; $di <= ($date_size - 1); $di++) {
            ...
            //echo $vserial[0]."/".$dateRangeStart."/".$dateRangeEnd."/".$sortBy,
            deviceDataBetweenDates($vserial[0],$dateRangeStart,$dateRangeEnd,$sortBy,$parameterizeData,$SortedDataObject);
        ...
        if ($point_type == 'line') {
            //echo "outside";
            echo $googleMapthisapi->addPolylineMarker("map_div", $lat_arr_last, $lng_arr_last, $datetime_arr_last, $vserial_arr_last, $vehiclename_arr_last, $speed_arr_last, $vehiclenumber_arr_last, $io_str_last, $distance_travel_arr);
        } else {
            //echo "inside";
            echo $googleMapthisapi->addMultipleMarker("map_div", $lat_arr_last, $lng_arr_last, $datetime_arr_last, $vserial_arr_last, $vehiclename_arr_last, $speed_arr_last, $vehiclenumber_arr_last, $io_str_last, $distance_travel_arr);
        }
