	...
	if($mode==2)
	{
		...
		{	
			...
			{ 
				...
				$vnumber_str ="";
				$linetmp="";
				$vehicle_info=get_vehicle_info($root,$vserial[$zi]);
				...
				//getTrackMap($vserial[$i], $vehicle_detail_local[0], $vehicle_detail_local[2], $startdate,$enddate,$xmltowrite,$timeinterval,$distanceinterval,&$lineTmpTrack);
				//echo "vserial212=".$vserial[$i]."<br>";
				//echo "<textarea>".$lineTmpTrack."</textarea>";
				$io_type_value=$vehicle_detail_local[7];
				getTrackMap($vserial[$zi], $vehicle_detail_local[0], $vehicle_detail_local[2], $startdate,$enddate,$xmltowrite,$timeinterval,$distanceinterval,&$lineTmpTrack);
				...
				{  
					...
					while(!feof($xml))          // WHILE LINE != NULL
					{
						...
						if($DataValid==1)
						{
							...
							if($break_flag==1)
							{
							//echo "xmlDate=".$xml_date_current." xmldate2=".$enddate;
