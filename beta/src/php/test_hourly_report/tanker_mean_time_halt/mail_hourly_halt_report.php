...
$PASSWD = "mysql";
$account_id = "568";
if($account_id == "568") $user_name = "tanker_mean_time_halt";
...
$ev_run_start_time1 = $date." 22:30:00";
$ev_run_start_time2 = $date." 23:00:00";
...
//####################
$Vehicle_MeanTime = array();
$ColumnCount_MeantTime = array();
$meantime_lat = array(array());
$meantime_lng = array(array());
$meantime_halt_start = array(array());
$meantime_halt_end = array(array());
$meantime_halt_dur = array(array());
