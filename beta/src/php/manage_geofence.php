        ...
        echo" <form name='manage1'>
            <ol class='breadcrumb'>
                ...
                <li class='active'><b>Geofence&nbsp;</b>
                 ...
                 ";
         echo'
                   <a onclick="'.$js_function_name.'(\'src/php/manage_add_geofence.php\');" class="btn btn-default" data-toggle="tab" style="padding: 3px 12px;">
                   ...
                   <a onclick="'.$js_function_name.'(\'src/php/manage_edit_geofence_prev.php\');" class="btn btn-default" data-toggle="tab" style="padding: 3px 12px;">
		    <input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/manage_edit_geofence_prev.php\')"/><i class="fa fa-pencil" aria-hidden="true"></i> Edit
                   ...
                   <a onclick="'.$js_function_name.'(\'src/php/manage_assignment_geofence_prev.php\');" class="btn btn-default" data-toggle="tab" style="padding: 3px 12px;">
		    <input type="radio" name="new_exist" value="exist" onclick="'.$js_function_name.'(\'src/php/manage_assignment_geofence_prev.php\')"/><i class="fa fa-link" aria-hidden="true"></i> Assign
                   ...
                   <a onclick="'.$js_function_name.'(\'src/php/manage_deassignment_geofence_prev.php\');" class="btn btn-default" data-toggle="tab" style="padding: 3px 12px;">
