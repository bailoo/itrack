<?php
  ...
  <center>
	<table border=0 width = 100% cellspacing=2 cellpadding=0>
		<tr>
			<td height=10 class="text" align="center"><strong>Temperature Graph</strong></td>
		</tr>
	</table>
          ...
          <br>
						<table border=0 width = 100% cellpadding="3" cellspacing="2">							
							<tr>
								...
								<td width=20%></td>
								<td align="left">
									<input type="button" onclick="javascript:action_graph_temperature(this.form);" value="Enter">&nbsp;<input type="reset" value="Clear">
								</td>
							</tr>
				  </table>
