...
{ 
	...
	for($j=0;$j<$AccountNode->data->VehicleCnt;$j++)
	{
		...
		{	
			...
			$flag=1;
			$vehicle_info_local=$vehicle_name_local.",".$vehicle_type_local.",".$vehicle_number_1.",".$vehicle_tag_local.",".$max_speed_local.",".$vehicle_fuel_voltage.",".$vehicle_tank_Capacity.",".$tmp_iotype_str;
