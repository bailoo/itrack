     ...
     <ol class="breadcrumb" style="background-color:#f7fafc;padding:1px 15px;border-radius:0px">
                ...
                <li class="active"><b>Plant Account</b>&nbsp;&nbsp; 
                    <div id="tab" class="btn-group" data-toggle="buttons" >
                        <a onclick="'.$js_function_name.'(\'src/php/manage_account_plant_assignment_prev.php\')" class="btn btn-default" data-toggle="tab" style="padding: 1px 12px;">
                        ...
                        <a onclick="'.$js_function_name.'(\'src/php/manage_account_plant_deassignment_prev.php\')" class="btn btn-default" data-toggle="tab" style="padding: 1px 12px;">
