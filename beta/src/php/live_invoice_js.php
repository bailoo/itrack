...
function show_live_vehicles_invoice(tot_vehicle_live)
{
  var display_type="single";
  var poststr = "display_type1=" + encodeURI(display_type)+
				"&tot_vehicle_live="+tot_vehicle_live;      
  //alert(poststr);
  makePOSTRequest('../php/module_live_vehicles_invoice.php', poststr);
}
...
function set_alert_pending_view(){
	
	//alert("11");
	var param1 ="blackout_pending";
	var param2 ="divpopup_pending";
	...
	//alert("55");
    document.getElementById('loading_pending_alert').innerHTML="<font color=red><b>Please wait while Loading all Trigger status...</b></font>";	
	//alert("66");
	/*var poststr="";
    makePOSTRequest('src/php/manage_pending_trigger_show.php', poststr); */
	// MAKE FILTERED COPY
	//alert("ss"+document.getElementById('tot_flag').innerHTML);
	var tot_flag=0;//document.getElementById('tot_flag').innerHTML ;
		var poststr = "x=1";		
         //alert(poststr);
		$.ajax({
		type: "POST",
		url:'src/php/manage_pending_trigger_show.php',
		data: poststr,
		success: function(response){
		//console.log(response);
		//alert("response="+response);
		//document.getElementById('manage_pending_trigger_show').style.display='none';
		//document.getElementById('manage_pending_trigger_show').style.display="none";
	    document.getElementById('manage_pending_trigger_show').innerHTML="";
		
		$("#manage_pending_trigger_show").html(response);
		document.getElementById('loading_pending_alert').innerHTML="";
...
function close_alert_pending_view()
{
...
function close_alert_pending_view_final(tripid,alert_name,trip_vehicle,trip_startdate,trigger_sno)
{
	//alert(tripid);
	//alert(trip_vehicle);
	//alert(trip_startdate);
	//alert(enddate);
...
function setclosePending_alert(sno,type){

var currentdate = new Date(); 
	if(currentdate.getDate()<10)
	{
		var cDay="0"+currentdate.getDate();
	}
	else
	{
	...
	{
		var cMonth="0"+currentdate.getMonth()+1;
	...
	{
		var cHr="0"+currentdate.getHours();
	}
	else
	{
		var cHr=currentdate.getHours();
	}
	
	if(currentdate.getMinutes()<10)
	{
		var cMin="0"+currentdate.getMinutes();
	}
	else
	{
	...
	{
		var cSec="0"+currentdate.getSeconds();
	}
	else
	{
...
var datetimeUnique =  cHr + ":"  
                + cMin + ":" 
                + cSec;
	
	if(document.getElementById(type+'_'+sno).checked==true){
		//alert("hello1");
		//document.getElementById('called_pending').value = "";	
		document.getElementById('calledperson_pending').value = "";	
		document.getElementById('hrs_pending').value =  datetimeUnique;
		document.getElementById('alert_remark_pending').value = "";		
		
		//document.getElementById('called_pending1').value = "";	
		document.getElementById('calledperson_pending1').value = "";	
		document.getElementById('hrs_pending1').value =  datetimeUnique;
		document.getElementById('alert_remark_pending1').value = "";		
		
		//document.getElementById('called_pending2').value = "";	
		document.getElementById('calledperson_pending2').value = "";	
		document.getElementById('hrs_pending2').value =  datetimeUnique;
		document.getElementById('alert_remark_pending2').value = "";		
		
		//document.getElementById('called_pending3').value = "";	
		document.getElementById('calledperson_pending3').value = "";	
		document.getElementById('hrs_pending3').value =  datetimeUnique;
		document.getElementById('alert_remark_pending3').value = "";		
		
		//document.getElementById('called_pending4').value = "";	
		document.getElementById('calledperson_pending4').value = "";	
		document.getElementById('hrs_pending4').value =  datetimeUnique;
		document.getElementById('alert_remark_pending4').value = "";		
		
		document.getElementById('type_pending').value = type;	
		document.getElementById('sno_pending').value = sno;	
	
		var param1 ="blackout";
		//var param2 ="divpopup_plant2";
		var param2 ="divpopup_close_pending";
		...
		//alert("hello2");
		//document.getElementById(type+'_remarks_'+sno).value="";
		 
		var type = document.getElementById('type_pending').value;	
		var sno = document.getElementById('sno_pending').value;
		
	    document.getElementById('type_pending').value="";	
	    document.getElementById('sno_pending').value="";
        
        document.getElementById(type+'_'+sno).checked=false;		
			
		//document.getElementById('called_pending').value = "";	
		document.getElementById('calledperson_pending').value = "";	
		document.getElementById('hrs_pending').value = "";	
		document.getElementById('alert_remark_pending').value = "";		
		
		//document.getElementById('called_pending1').value = "";	
		document.getElementById('calledperson_pending1').value = "";	
		document.getElementById('hrs_pending1').value = "";	
		document.getElementById('alert_remark_pending1').value = "";		
		
		//document.getElementById('called_pending2').value = "";	
		document.getElementById('calledperson_pending2').value = "";	
		document.getElementById('hrs_pending2').value = "";	
		document.getElementById('alert_remark_pending2').value = "";		
		
		//document.getElementById('called_pending3').value = "";	
		document.getElementById('calledperson_pending3').value = "";	
		document.getElementById('hrs_pending3').value = "";	
		document.getElementById('alert_remark_pending3').value = "";		
		
		//document.getElementById('called_pending4').value = "";	
		document.getElementById('calledperson_pending4').value = "";	
		document.getElementById('hrs_pending4').value = "";	
		document.getElementById('alert_remark_pending4').value = "";	
...
function closePending_alert()
{
	var rem=" ";
	var flag_submit=0;
	
	if(document.getElementById('called_pending').value!="" && document.getElementById('alert_remark_pending').value!="" )
	{
		rem +=document.getElementById('called_pending').value+" "+document.getElementById('calledperson_pending').value+" at<font color=red>"+document.getElementById('hrs_pending').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending').value+"</font>";
		flag_submit=1; 
	}
	if(document.getElementById('called_pending1').value!="" && document.getElementById('alert_remark_pending1').value!="" )
	{
		 rem +=document.getElementById('called_pending1').value+" "+document.getElementById('calledperson_pending1').value+" at<font color=red>"+document.getElementById('hrs_pending1').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending1').value+"</font>";
		flag_submit=1; 
	}
	if(document.getElementById('called_pending2').value!="" && document.getElementById('alert_remark_pending2').value!="" )
	{
		rem +=document.getElementById('called_pending2').value+" "+document.getElementById('calledperson_pending2').value+" at<font color=red>"+document.getElementById('hrs_pending2').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending2').value+"</font>";
		flag_submit=1; 
	}
	if(document.getElementById('called_pending3').value!="" && document.getElementById('alert_remark_pending3').value!="" )
	{
		rem +=document.getElementById('called_pending3').value+" "+document.getElementById('calledperson_pending3').value+" at<font color=red>"+document.getElementById('hrs_pending3').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending3').value+"</font>";
		flag_submit=1; 
	}
	if(document.getElementById('called_pending4').value!="" && document.getElementById('alert_remark_pending4').value!="" )
	{
		rem +=document.getElementById('called_pending4').value+" "+document.getElementById('calledperson_pending4').value+" at<font color=red>"+document.getElementById('hrs_pending4').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending4').value+"</font>";
		flag_submit=1;          
	}
	...
	if(flag_submit==1 )
	{
	   ...
	   var sno = document.getElementById('sno_pending').value;
	   /*
	    var rem=document.getElementById('called_pending').value+" "+document.getElementById('calledperson_pending').value+" at<font color=red>"+document.getElementById('hrs_pending').value+
				"</font> hrs .<font color=red>"+document.getElementById('alert_remark_pending').value+"</font>";
		//alert("submit ok"+rem);*/
		var tot_flag=0;//document.getElementById('tot_flag').innerHTML ;

		var poststr =
		"action_type=close_pending_alert"+
		"&trigger="+type+		
		"&rem="+rem+
		"&Total_flag="+tot_flag+
		"&trigger_sno="+sno;
		...
		//var param2 ="divpopup_plant2";
		var param2 ="divpopup_close_pending";
		var param3 ="blackout_pending";
		var param4 ="divpopup_pending";
		...
		makePOSTRequest('src/php/action_manage_pending_trigger.htm', poststr);	
		
	}
	else
	{
		alert("At least any one Escalation Level Remarks will be required to close Trigger");
		return false;
		var type = document.getElementById('type_pending').value;	
		var sno = document.getElementById('sno_pending').value;
...
function closePending_alertCancel()
{
	var type = document.getElementById('type_pending').value;	
	var sno = document.getElementById('sno_pending').value;
