...
<?php
  ...
  $query="SELECT DISTINCT req_id FROM request WHERE create_id='$account_id' ORDER BY create_date DESC";
...
<?php
  ...
  echo '
    <tr>
      <td colspan="9" align="center">
        <b>Track Your Feedback Requests</b>
  ...
  if ($count>0)
  {
    foreach ($id as $i=>$req_id)
    {
      ...
      echo "<td><a href=\"javascript:show_request($req_id,1)\";>".$body[$req_id]."</a></td>";
