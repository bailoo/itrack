				...
				<TR>
					<TD valign="top">
						<table border=0 width = 100% cellspacing=2 cellpadding=0>
							<tr>
								<td height=10 STYLE="background-color:#f0f7ff" class="text" align="center">Speed Graph</td>
							</tr>
						</table>
						<?php
							if($access=="0")
								...
								echo'<div STYLE=" height:'.$height.'+10px; overflow:auto">';
								?>
					...
					<?php 
						...
						if($Result)
						{
							...
							if($num_rows)
							{																
								echo'<form action="DailySpeedGraphAction.php" method="GET">';
								...
								echo'<td align="center" class="text">(Speed) From ';								
								...
								echo'<IMG SRC="SpeedGraph.php?width='.$width.'&height='.$height.'&day='.$day.'&month='.$month.'&year='.$year.'&vehicleid='.$vehicleid.'&xmin='.$xmin.'&xmax='.$xmax.'&ymin='.$ymin.'&ymax='.$ymax.'">';
								echo'</td></tr>
								</table>';								
							}
						}																	
