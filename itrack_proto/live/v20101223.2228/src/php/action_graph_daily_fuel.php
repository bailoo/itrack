				...
				<TR>
					<TD>
						<table border=0 width = 100% cellspacing=2 cellpadding=0>
							<tr>
								<td height=10 STYLE="background-color:#f0f7ff" class="text" align="center">Fuel Graph</td>
							</tr>
						</table>
						<?php
							if($access=="0")
...
<?php 
						...
						$tablename = "t".$tableid;						
						if($day<=9)
							$Query="select * from ".$tablename." where VehicleID='$vehicleid' and DateTime Like '".$year."-".$month."-0".$day."%'";
						else
							$Query="select * from ".$tablename." where VehicleID='$vehicleid' and DateTime Like '".$year."-".$month."-".$day."%'";
						//echo $Query;
						$Result=mysql_query($Query,$DbConnection);
						...
						if($Result)
						{
							...
							if($num_rows)
							{								
								echo'<form action="DailyFuelGraphAction.php" method="GET">';
								...
								echo'<td align="center" class="text">(Fuel) From ';								
								...
								echo'<table border=0 width = 100% cellpadding=3><tr><td align="center">';
								echo'<IMG SRC="FuelGraph.php?width='.$width.'&height='.$height.'&day='.$day.'&month='.$month.'&year='.$year.'&vehicleid='.$vehicleid.'&xmin='.$xmin.'&xmax='.$xmax.'&ymin='.$ymin.'&ymax='.$ymax.'">';
																
								 /*echo'<a href="FuelGraph.php?width='.$width.'&height='.$height.'&day='.$day.'&month='.$month.'&year='.$year.'&vehicleid='.$vehicleid.'">click</a>';*/
						...
						else
						{
							...
							echo "<META HTTP-EQUIV=\"Refresh\" CONTENT=\"1; URL=DailyFuelGraph.php\">";
