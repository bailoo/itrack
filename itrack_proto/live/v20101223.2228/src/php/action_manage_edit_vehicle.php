...
<?php
  ...
  {
    $query = "UPDATE vehicle SET VehicleName='$post_vehicle_name',VehicleType='$post_vehicle_type',tag='$post_vehicle_tag',vehicle_number='$post_vehicle_number',max_speed='$post_max_speed',edit_id='$account_id',edit_date='$date'";
