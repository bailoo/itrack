	...
	*/
	...
	if (browser.dom || browser.ie4){
		...
		browser.platform=='Win32'?height=190:height=200;
	...
	function Calendar()
  {
    ...
    {
	    this.containerLayer.clip.height=400;
	    this.containerLayer.clip.width=400;
	  }
 	...
 	Calendar.prototype.getFirstDOM = function()
 {
	...
	Calendar.prototype.getDaysInMonth = function ()
  {
	...
	Calendar.prototype.buildString = function(){
	  var tmpStr = '<form onSubmit="this.year.blur();return false;">';
    tmpStr += '<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0" class="calBorderColor">';
    tmpStr += '<tr><td valign="top">';
    tmpStr += '<table width="100%"  border="0" cellspacing="0" cellpadding="0" class="calBgColor">';
	  tmpStr += '<tr>';
	  tmpStr += '<td width="70%" class="cal" align="left">';
	  if (this.hasDropDown) {
	  ...
	  */
	  ...
	  tmpStr += '<table width="100%" border="1" cellspacing="0" cellpadding="1" class="calBgColor">';
	  tmpStr += '<tr>';
	    for (var i=0;i<7;i++){
	  ...
	  tmpStr += '</table></td></tr>';
	  /*var switch_row=document.getElementById('date_switch').value;
	  if(switch_row=="0")
	  {
    tmpStr += '<tr><td align="center"><input type="text" id="time1" style="WIDTH:20px" value="00">&nbsp;:&nbsp;<input type="text" id="time2" style="WIDTH:20px" value="00">&nbsp;:&nbsp;<input type="text" id="time3" style="WIDTH:20px" value="00"> </td></tr>';
    }
    else if(switch_row=="1")
    { 
    var datetime = new Date();
    tmpStr += '<tr><td align="center"><input type="text" id="time1" style="WIDTH:20px" value='+datetime.getHours()+'>&nbsp;:&nbsp;<input type="text" id="time2" style="WIDTH:20px" value='+datetime.getMinutes()+'>&nbsp;:&nbsp;<input type="text" id="time3" style="WIDTH:20px" value='+datetime.getSeconds()+'></td></tr>';
    }*/
    tmpStr += '</table></form>'
	  return tmpStr;
	}
 ...
 /* var t1=document.getElementById("time1").value;
  ...
  {
 //alert("s_time="+s_time);
  //	document.getElementById('date_switch').value=s_time;
...
/*Calendar.prototype.show1 = function(event, target, bHasDropDown, dateFormat, dateFrom, dateTo){
alert("test_1") ;
	// calendar can restrict choices between 2 dates, if however no restrictions
	// are made, let them choose any date between 1900 and 3000
	this.dateFrom = dateFrom || new Date(1900,0,1);
	...
	window.onresize=function()
  {
   ...
   // onload="javascript:resize()"  onresize="javascript:resize()"
