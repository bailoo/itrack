<?php
	...
	//echo "str=".$str;
	echo "search_vehicle2##".$local_vehicle_id1."##";	
					...
					if($search)
					{
						...
						{						
							...
							if($flag==1)
							{
								...
								echo"<tr id=\"word".$country."\" onmouseover=\"highlight(1,'".$country."');\" onmouseout=\"highlight(0,'".$country."');\" onClick=\"display_2('".$common_value."');\">
										\n						
