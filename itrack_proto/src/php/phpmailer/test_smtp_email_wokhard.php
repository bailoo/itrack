...
//include_once("action_visit_area_violation_mail.php");
...
/*$query = "SELECT * FROM mail_info_visit_area WHERE status=1";
echo "<br>query=".$query;
...
$sno = 1;
$fileatt1[] = ""; // Path to the file 
$fileatt_type1[] = ""; // File Type 
$fileatt_nam1[] = ""; // Filename that will be used for the file as the attachment 
//$email_from1[] = $row->email_from; // Who the email is from 
$email_from1[] = "support@iembsys.co.in";
$email_subject1[] = "TEST SUBJECT"; // The Subject of the email 
$email_message1[] = "TEST MSG"; // Message that the email has in it 
$email_to1[] = "rizwan@iembsys.com"; // Who the email is too 

//$query = "UPDATE mail_info_visit_area SET datetime_sent='$datetime_sent',status=0 WHERE sno='$sno'";
