<?php 
	...
	if($display_type!="all")
	{
		...
		echo'<br><center>
					<input type="button" name="submit" value="Enter" onclick="javascript:manage_grouping_validation(this.form)">
				 </center>
		</form>';
	}
	...
	function DisplayHierarchy($AccountNode)
	{
		...
		echo"<td>&nbsp;                
				<INPUT TYPE='checkbox' name='manage_option[]' VALUE='$account_id_local'><a href='tree_account_detail.php?account_id_local=$account_id_local'>".$account_name."</a>
			</td>";
