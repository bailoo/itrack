<?php	
	...
	echo "search_vehicle_hindalco_self##".$box."##";
				...
				foreach ($array as $a ) 
				{
					...
					{					
						...
						{						
							...
							echo"<tr id=\"word".$country."\" onmouseover=\"highlight(1,'".$country."');\" onmouseout=\"highlight(0,'".$country."');\" onClick=\"display_hindalco_invoice_self_vehicle('".$common_value."');\">
									\n						
