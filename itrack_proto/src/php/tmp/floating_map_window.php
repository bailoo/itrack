...
echo'
<div id="window" style="display:none; position:absolute; z-index:10; left:300px; top:100px; width:490px;height:320px;background-color:#dde3eb; border:1px solid #464f5a;">';
...
<br/>
  ...
  <!--Content-->
  <div id="map" style="width:490px; height:280px; position: relative; background-color:background-color: rgb(229, 227, 223);" class="ukseries_div_map">
