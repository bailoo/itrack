...
function load_vehicle_on_map(vname,arr_datetime,dept_datetime,lat,lng)
{	
	...
	marker = CreateVehicleMarker(vname,arr_datetime,dept_datetime,lat,lng);	
...
function CreateVehicleMarker(vname,arr_datetime,dept_datetime,lat,lng)
{	
	...
	//alert("V2="+vname+" "+arr_datetime+" "+lat+" "+lng);

	PlotMarkerWithAddress(marker,point,vname,arr_datetime,dept_datetime);
...
function PlotMarkerWithAddress(marker,point,vehiclename,arr_datetime,dept_datetime) {
