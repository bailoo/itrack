...
<body>
	...
	<input type="hidden" id="all_hide_show_ids" value="vehicles_free_wheeling,vehicles_power_disconnect,vehicles_night_drive,vehicles_over_speed,vehicles_with_violation">
	...
	<tr>
		<td>
			<table align="center" width="95%" class="menu" border="1" rules="all" bordercolor="black" border=1>
				<tr onclick="javascript:show_hide_option('vehicles_with_violation','main_tr_1')" class="main_tr">
					<td>
						<table class="headings">
							<tr id="main_tr_1">
								<td align="center">
									Total number of Vehicles with Violation
								</td>
								<td align="center">
									-
								</td>
				...
				<tr id="vehicles_with_violation" style="display:none">
					<td>
				...
				<tr onclick="javascript:show_hide_option('vehicles_over_speed','main_tr_2')"  class="main_tr">
					<td>
						<table class="headings" >
							<tr id="main_tr_2">
								<td align="center">
									Total number of Vehicles with Over Speed
								</td>
								<td align="center">
									-
								</td>
				...
				<tr id="vehicles_over_speed" style="display:none">
					<td align="center">
						<table cellspacing=0 cellpadding=0 width="100%">
							<tr bgcolor="#CFE0F7">
								<td align="left">
				...
				<tr class="main_tr" onclick="javascript:show_hide_option('vehicles_night_drive','main_tr_3')">
					<td>
						<table class="headings" >
							<tr id="main_tr_3">
								<td align="center">
									Total number of Vehicles with Night Drive
								</td>
								<td align="center">
									-
								</td>
				...
				<tr id="vehicles_night_drive" style="display:none">
					<td align="center">
						<table cellspacing=0 cellpadding=0 width="100%">
							<tr bgcolor="#CFE0F7">
								<td align="left">
				...
				<tr class="main_tr" onclick="javascript:show_hide_option('vehicles_power_disconnect','main_tr_4')">
					<td>
						<table class="headings">
							<tr id="main_tr_4">
								<td align="center">
									Total number of Vehicles with Power Disconnect
								</td>
								<td align="center">
									-
								</td>
				...
				<tr id="vehicles_power_disconnect" style="display:none">
					<td align="center">
						<table cellspacing=0 cellpadding=0 width="100%">
							<tr bgcolor="#CFE0F7">
								<td align="left">
				...
				<tr class="main_tr" onclick="javascript:show_hide_option('vehicles_free_wheeling','main_tr_5')">
					<td>
						<table class="headings">
							<tr id="main_tr_5">
								<td align="center">
									Total number of Vehicles with Free Wheeling
								</td>
								<td align="center">
									-
								</td>
				...
				<tr id="vehicles_free_wheeling" style="display:none">
					<td align="center">
						<table cellspacing=0 cellpadding=0 width="100%">
							<tr bgcolor="#CFE0F7">
								<td align="left">
