<?php
	...
	echo"<br>			
        ...
        <tr>
          <td height='5px' align='center' colspan='6' class='text'>&nbsp;<input type='checkbox' name='all' value='1' onClick='javascript:select_all_vehicle(this.form);'>&nbsp;&nbsp;Select All</td>
        </tr>";
        ...
        <table border=0 cellspacing=0 cellpadding=0 class='module_left_menu' align='center'>					
          ...
          if($row_result!=null)
            ...
            $k=0;
              ...
              echo"
							<td>
								&nbsp<INPUT TYPE='radio' name='station_id' VALUE='$geo_id'>
					...
					{			    
						...
						if($vehicle_id!=null)
						{
							...
							if($i>=$vehicle_cnt)
							{
								...
								$vehicle_cnt++;
								$td_cnt++;
								$query="SELECT vehicle_id FROM vehicle WHERE vehicle_id='$vehicle_id' AND status='1'";
								//echo "query=".$query;
								$result=mysql_query($query,$DbConnection);
