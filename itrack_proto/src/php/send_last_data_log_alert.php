...
$xml_file1 = "../../../xml_vts/xml_last/862170010624383.xml";
$smessage1=false;
$smessage2=false;
$smessage3=false;
$smessage4=false;
...
if(file_exists($xml_file1))
{
	...
	$server_time1=time();
	//echo "\n862170018371375::mtime=".date('Y-m-d H:i:s',$modified_datetime1).", ST=".date('Y-m-d H:i:s',$server_time1);
...
//if($timediff1>=60)
	{
		$imei_no='862170010624383';
		$smessage1=true;				
	}
}

$xml_file2 = "../../../xml_vts/xml_last/862170018371953.xml";
...
//if($timediff1>=60)
	{
		$imei_no='862170018371953';
		$smessage2=true;				
	}
}
$xml_file3 = "../../../xml_vts/xml_last/862170017808948.xml";
...
//if($timediff1>=60)
	{
		$imei_no='862170017808948';
		$smessage3=true;				
	}
}

$xml_file4 = "../../../xml_vts/xml_last/862170011629704.xml";
