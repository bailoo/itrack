<?php 
	...
	$select_all_td="<td class='text'>&nbsp;<input type='checkbox' name='all_1' value='1' onClick='javascript:select_report_all_portal_option(this.form);'>&nbsp;&nbsp;Select All</td>";			
	...
	if($display_type!="all")
	{
		...
		echo'<br><center>
					<input type="button" name="submit" value="Enter" onclick="javascript:report_tree_validation(this.form)">
				 </center>
		</form>';
	}
