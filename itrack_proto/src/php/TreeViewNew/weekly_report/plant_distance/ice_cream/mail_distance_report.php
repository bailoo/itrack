...
include_once($abspath."/weekly_report/plant_distance/ice_cream/get_master_detail.php");
include_once($abspath."/weekly_report/plant_distance/ice_cream/mail_action_report_distance.php");
...
//echo "\nT1";
$inc_serial = rand();
$filename_title = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_ICECREAM)_'.$current_date."_".$inc_serial;
...
$subject = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_ICECREAM)_'.$current_date;
$message = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_ICECREAM)_'.$current_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>";
