...
include_once($abspath."/weekly_report/plant_distance/delhi/get_master_detail.php");
include_once($abspath."/weekly_report/plant_distance/delhi/mail_action_report_distance.php");
...
//echo "\nT1";
$inc_serial = rand();
$filename_title = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_DELHI)_'.$current_date."_".$inc_serial;
...
$to = 'Vijay.Singh@motherdairy.com,teetu.kumar@motherdairy.com,call1.center@motherdairy.com,ashish.sawhney@motherdairy.com,Kapil.dhaka@motherdairy.com,Rahul.tiwari@motherdairy.com,Shiv.sharma@motherdairy.com,Logistic.Ppg@motherdairy.com,ashish@iembsys.co.in';
$subject = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_DELHI)_'.$current_date;
$message = 'FORTNIGHTLY_DISTANCE_REPORT_(MOTHER_DELHI)_'.$current_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>";; 
