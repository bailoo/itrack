<?php
  ...
  $report_title = "WOCKHARDT MONTHLY VTS REPORT -Vehicle:".$vname_global[$j]." Month-($previous_month)";
  ...
  for($q=0;$q<$total_days;$q++)                       //******** TOTAL DAYS IN PREVIOUS MONTH
  {
    ...
    $starttime = $date_global[$j][$q]." 09:00:00";
    $endtime = $date_global[$j][$q]." 18:00:00";
  ...
  $date1 = $previous_year."-".$previous_month."-01 09:00:00";
  $date2 = $previous_year."-".$previous_month."-".$total_days." 18:00:00";
