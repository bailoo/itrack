<?php 
  ...
  $vcolor3 = "#".$vcolor[2];
	...
	//echo "category1=".$category1.", disp_type=".$display_type."<br>";
  ...
  function common_function_for_vehicle($vehicle_imei,$vehicle_id,$vehicle_name)
    ...
    global $vcolor3;		
		...
		echo'<tr> 
				<td align="left">&nbsp;<INPUT TYPE="hidden"  name="vehicleserial" VALUE="'.$vehicle_imei.'"></td>
				<td><A HREF="#" style="text-decoration:none;" onclick="main_vehicle_information('.$vehicle_id.')">';
  ...
  {      
      ...
      { 
        ...
        foreach($vehicle_name_arr as $vehicle)
        {
          ...
          <tr>
            <td align="left">
              <INPUT TYPE="hidden"  name="vehicleserial" VALUE="'.$imei_arr[$vehicle].'">
            </td>
            <td>
          ...
          <tr>
            <td>
              <a href="#" style="text-decoration:none;" onclick="javascript:movingVehicle_prev('.$imei_arr[$vehicle].');"><font color="'.$color.'">'.$vehicle.'</font></a>
            </td>
          </tr>
          ';          
        }
    ...
    $type="group";
		for($j=0;$j<$sizeofgroup;$j++)
		{
			...
			$vehicle_cnt=0;
			echo'<tr> 
					<td colspan="2"><font color="'.$vcolor1.'"><b>&nbsp;&nbsp;'.$group_name.'('.$groupid[$j].')'.'</b></font></td>
				</tr>';
				$green_cnt1=0;  $gray_cnt1=0;
   ...
   // echo "sizeofgreen=".$vehicle_name_arr[$color]."sizeofgray=".$vehicle_name_arr[$color]."<br>";
    ...
    $type="user";
		for($j=0;$j<$sizeofuserid;$j++)
		{
		  ...
		  echo'<tr> 
				<td colspan="2"><font color="'.$vcolor1.'"><b>&nbsp;&nbsp;'.$user_name.'</b></font></td>
			</tr>';
			$green_cnt1=0;  $gray_cnt1=0;
	...
	function get_vehicle_tag($AccountNode,$div_option_values,$category1)
	{
		...
		for($j=0;$j<$sizeofvehicletag;$j++)
		{
			$vehicle_cnt=0;
			echo'<tr> 
					<td colspan="2"><font color="red"><b>&nbsp;&nbsp;'.$vehicle_tag[$j].'</b></font></td>
				</tr>';
	...
	function get_vehicle_type($AccountNode,$div_option_values,$category1)
	{
		...
		for($j=0;$j<$sizeofvehicletype;$j++)
		{
			$vehicle_cnt=0;
			echo'<tr> 
					<td colspan="2"><font color="red"><b>&nbsp;&nbsp;'.$vehicle_type[$j].'</b></font></td>
				</tr>';
