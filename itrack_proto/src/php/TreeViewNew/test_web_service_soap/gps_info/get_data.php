...
$client = new nusoap_client("http://www.itracksolution.co.in/test_web_service_soap/gps_info/index.php?wsdl", true);
//$client = new nusoap_client("http://www.itracksolution.co.in/test_web_service_soap/gps_info/");
