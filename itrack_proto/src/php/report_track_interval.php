<?php
	...
	$function_string='get_'.$vehicle_display_option1.'_vehicle_radio_interval';
  ...
  <center>
  	<table border=0 width = 100% cellspacing=2 cellpadding=0>
  		<tr>
  			<td height=10 class="report_heading" align="center">Track Interval Report</td>
  		</tr>
  	</table>

		<form  method="post" name="trackIntForm" action="src/php/Full_data_track_interval_prev.php" target="_blank">	
	...
	<fieldset class="report_fieldset">';
      ...
      echo'<fieldset class="report_fieldset">
    	...
    	echo '<option value="60">1 Min</option>';
    								
    	echo '<option value="300" selected>5 Min</option>';
    	
    	echo '<option value="600">10 Min</option>';*/
    	
    	echo '<option value="1800">30 Min</option>';
    	
    	echo '<option value="3600">1 Hr.</option>';
    	
    	echo '<option value="7200">2 Hr.</option>';
    								
    	//echo '<option value="10800">3 Hr.</option>';
    	
    	echo '<option value="14400">4 Hr.</option>';
    
    	echo '<option value="21600">6 Hr.</option>';
    
    	//echo '<option value="28800">8 Hr.</option>';
    
    	echo '<option value="43200">12 Hr.</option>';
	...
	<tr>
		<td align="center">
			<table>
				<tr>
					<td>			
						<input type="button" onclick="javascript:action_report_track_interval(this.form)" value="Enter">&nbsp;<input type="reset" value="Clear">
					</td>
				</tr>
			</table>
		</td>
...
<!--<div align="center" id="loading_msg" style="display:none;"><br><font color="green">loading...</font></div>-->
 ';
 echo '<input type="hidden" id="xml_file" name="xml_file">';
 echo '<input type="hidden" id="vserial" name="vserial" >';
 echo '<input type="hidden" id="startdate" name="startdate" >';
 echo '<input type="hidden" id="enddate" name="enddate" >';
 echo '<input type="hidden" id="text_report_io_element" name="text_report_io_element" >';
 echo '<input type="hidden" id="mode" name="mode" >';
 echo '<input type="hidden" id="time_interval" name="time_interval" >';
 echo '<input type="hidden" id="dwt" name="dwt" >';
 ';
