<?php
	...
	echo"<br>			
			<form name='manage1' method='post'>
				<center><strong> DELETE STATION </strong>
				<br>			
				...
				<table border=0 cellspacing=0 cellpadding=0 class='module_left_menu' align='center'>					
					...
					$data=getStationIDCustomerNoStation($common_id1,$DbConnection);					
					if(sizeof($data)>0)
					{  
						$k=0;	
			...
			echo'</table>
				...
				<br>
					<input type="button" id="enter_button" name="enter_button" Onclick="javascript:return action_manage_station(\'delete\')" value="Delete">&nbsp;<input type="reset" value="Cancel">
