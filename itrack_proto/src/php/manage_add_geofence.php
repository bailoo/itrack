<?php 
	...
	echo'
				<table border="0" class="manage_interface">
					<tr>
						<td>Name</td><td>:</td>
						<td><input type="text" name="add_geo_name" id="add_geo_name" onkeyup="manage_availability(this.value, \'geofence\')" onmouseup="manage_availability(this.value,\'geofence\')" onchange="manage_availability(this.value, \'geofence\')"></td>
					</tr>
					<tr>
						<td>Coord</td><td>:</td>
