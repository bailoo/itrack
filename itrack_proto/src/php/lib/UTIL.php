...
class UTIL
{
	...
	public static function getAllBinEdges($fromTime, $toTime, $intervalTS)
	{
		$allTimeArray = array();
		$fromTimeTS = strtotime($fromTime);
		$toTimeTS = strtotime($toTime);
	...
	public static function linearFitX2Y($x, $line)
	{
		...
		// BUG::debug("($x1,$y1) ($x2,$y2) ($x,$y)");
		return $y;
	}

	public static function linearFitX2Y1($x, $line)
	{
