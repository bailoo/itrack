<?php	
	...
	//echo "str=".$str;
	echo "search_vehicle_substation2##".$local_vehicle_id1."##";
				...
				foreach ($array as $a ) 
				{
					...
					{					
						...
						{						
							...
							echo"<tr id=\"word".$country."\" onmouseover=\"highlight(1,'".$country."');\" onmouseout=\"highlight(0,'".$country."');\" onClick=\"display_substation_2('".$common_value."');\">
									\n						
