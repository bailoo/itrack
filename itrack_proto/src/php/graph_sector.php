<?php
  ...
  //echo "<center><h3><font color=blue>PAGE IS UNDER MAINTENANCE</font></h3></center><br>";  
  echo'
  <center>
  	<table border=0 width = 100% cellspacing=2 cellpadding=0>
  		<tr>
  			<td height=10 class="report_heading" align="center">Sector Graph</td>
  		</tr>
  	</table>
  ...
  echo'
  <br>
  <input type="hidden" id="display_flag" value="0" />
  	...
  	<tr>
  		<td align="center">
  			<table>
  				<tr>
  					<td>			
  						<input type="button" onclick="javascript:action_graph_sector(thisform)" value="Enter">&nbsp;<input type="reset" value="Clear">
  					</td>
  				</tr>
  			</table>
  		</td>
