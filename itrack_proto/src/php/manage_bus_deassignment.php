  ...
  ";      
   echo'
   	   <fieldset class=\'manage_fieldset\'>
				<legend><strong>Bus De-Assignment</strong></legend>
         ...
         /*   echo'
          <tr>
            ...
            $query="SELECT busroute_id,busroute_name FROM busroute WHERE user_account_id='$common_id1' AND status='1'";
          ...
          */
          ...
          <tr>
            ...
            <td><b> : &nbsp;&nbsp;</b></td>
    			   <td>
              <select name="bus_id" id="bus_id" onchange="show_assigned_record(manage1);">
              <option value="select">Select</option>';
     ...
     // echo $query;	
		 ...
		 echo'	 
				<br>
					<input type="button" id="enter_button" name="enter_button" Onclick="javascript:return action_manage_bus(\'deassign\')" value="De-Assign">&nbsp;<!-- <input type="reset" value="Cancel">  -->
