    ...
    if (sizeof($final_vehicle) > 0) {
        ...
        if ($shift == "ZPME") {
            ...
            if ($secondary_vehicle_list != '') {
                ...
                $query_update1 = "UPDATE route_assignment2 set route_name_ev='',evening_update_time='$current_datetime',remark_ev='UpdtBy-Master',edit_date='$current_datetime',edit_id='$account_id' WHERE user_account_id='$account_id' AND status=1";
            }
            ...
            if ($secondary_vehicle_list != '') {
                ...
                $query_update1 = "UPDATE route_assignment2 set route_name_mor='',morning_update_time='$current_datetime',remark_mor='UpdtBy-Master',edit_date='$current_datetime',edit_id='$account_id' WHERE user_account_id='$account_id' AND status=1";
            }
    ...
    for ($i = 0; $i < sizeof($final_vehicle); $i++) {
        ...
        if ($shift == "ZPME") {
            if ($secondary_vehicle_list != '') {
                ...
                $query_update2 = "UPDATE route_assignment2 set route_name_ev='$route_str',evening_update_time='$current_datetime',remark_ev='UpdtBy-Master',edit_date='$current_datetime',edit_id='$account_id' WHERE vehicle_name='$final_vehicle[$i]' AND user_account_id='$account_id' AND status=1";
            }
            ...
            if ($secondary_vehicle_list != '') {
                ...
                $query_update2 = "UPDATE route_assignment2 set route_name_mor='$route_str',morning_update_time='$current_datetime',remark_mor='UpdtBy-Master',edit_date='$current_datetime',edit_id='$account_id' WHERE vehicle_name='$final_vehicle[$i]' AND user_account_id='$account_id' AND status=1";
            }
            //echo "<br>".$query_update;
            $result_update2 = mysql_query($query_update2, $DbConnection);
        }
