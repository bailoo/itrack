...
?>
	...
	<table border="0" class="manage_interface" cellspacing="2" cellpadding="2">
		<tr>
			...
			<td>				
				<select name="location_id" id="location_id" onchange="javascript:show_location_coord(manage1);">
		...
		<tr>
			<td colspan="3" align="center">
				<input type="button" value="Update" id="enter_button" onclick="javascript:return action_manage_schedule('edit')"/>&nbsp;
				<input type="button" value="Delete" onclick="javascript:action_manage_schedule('delete')"/>
			</td>
		</tr>
	</table>
