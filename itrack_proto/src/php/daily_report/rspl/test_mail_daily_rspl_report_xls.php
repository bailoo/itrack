...
$r=0;
$worksheet_title = "DAILY VTS_REPORT -RSPL";
...
while($row_account = mysql_fetch_object($result_account))
{
	...
	$worksheet->write($r, 3, "Latitude", $heading_format2);
	$worksheet->set_column(3, 3, 20); 
	$worksheet->write($r, 4, "Longitude", $heading_format2);
	$worksheet->set_column(4, 4, 20); 
	$worksheet->write($r, 5, "Google Location", $heading_format2);
	...
	{                      
		...
		$worksheet->write($r, 3, "", $heading_format3); 
		...
		$worksheet->write($r, 3, $last_lat[$i], $heading_format3);
		$worksheet->write($r, 4, $last_lng[$i], $heading_format3);
		...
		$worksheet->write($r, 5, $placename1, $heading_format3);
	...
	//$worksheet->write($r, 3, "", $heading_format2);
...
$worksheet->write_blank($r, 1,$heading_format2); 
$worksheet->write($r, 2, $count_imei, $heading_format1);
//$worksheet->write($r, 3, "", $heading_format1);
$r++;

$worksheet->write($r, 0, "TOTAL *INACTIVE VEHICLES", $heading_format2);
$worksheet->write_blank($r, 1,$heading_format2); 
$worksheet->write($r, 2, $count_inactive, $heading_format1);
//$worksheet->write($r, 3, "", $heading_format1);
$r++;

$worksheet->write($r, 0, "TOTAL *NO GPS VEHICLES", $heading_format2);
$worksheet->write_blank($r, 1,$heading_format2); 
$worksheet->write($r, 2, $count_nogps, $heading_format1);
//$worksheet->write($r, 3, "", $heading_format1);
$r++;


$r++;
$worksheet->write($r, 0, "", "");    //ACCOUNT DETAIL
$worksheet->write_blank($r, 1, "");	
$r++;     

$worksheet->write($r, 0, "ACCIDENTAL", $heading_format2);
$worksheet->write_blank($r, 1,$heading_format2);   
$worksheet->write($r, 2, $accidental_vehicles, $heading_format1);  
...
$headers .= "Cc: jyoti.jaiswal@iembsys.com,support1@iembsys.com";
