...
/////********* CREATE EXCEL FILE *******************///////
$filename_title = 'MONTHLY_WORKHARDT_VTS_REPORT3';  
...
{            
  ...
  $worksheet->write($r,$c, $no_data_string, $border2);                    //NO MOVEMENT REPORT
  $c++;    
...
$subject = $filename_title." (".$prev_month_str.")";
$message = $filename_title." (".$prev_month_str.")"; 
