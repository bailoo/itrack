...
$r=0;
$worksheet_title = "DAILY VTS_REPORT -KEPL";
...
$report_title = "VTS TRACKING REPORT :KEPL -Date:".$previous_date;
...
$query_account = "SELECT account_id,user_id FROM account WHERE account_id=327 AND status=1";  //FOR KEPL
