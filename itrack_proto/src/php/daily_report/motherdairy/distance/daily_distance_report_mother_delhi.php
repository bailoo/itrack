...
$query_account = "SELECT account_id,user_id FROM account WHERE account_id=231 AND status=1";  //FOR MOTHER DELHI
...
function get_daily_distance_report_xml($vehicle_serial, $vname, $startdate, $enddate)
{
  ...
  $subject = 'DATA_ANALYSIS:-MOTHER_DELHI_VTS_REPORT'.$previous_date."/".$previous_year;
  $message = 'DATA_ANALAYSIS:-MOTHER_DELHI_VTS_REPORT'.$previous_date."/".$previous_year; 
