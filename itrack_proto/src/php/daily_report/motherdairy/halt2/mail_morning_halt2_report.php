...
//$current_date = date('Y-m-d', strtotime($date .' -1 day')); // LAST 4 DAYS : -2, -3, -4, -5
...
//  $to = 'Shreya.Shinde@motherdairy.com,Vijay.Singh@motherdairy.com,Ravindra.Negi@motherdairy.com,Teetu.Kumar@motherdairy.com';
