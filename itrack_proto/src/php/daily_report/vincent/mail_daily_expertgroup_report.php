...
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
        ...
        "vehicle_grouping.account_id=302 AND vehicle.status=1 AND vehicle_assignment.status=1";                                                          
...
*/    
  ...
  {
		$inc_serial=$i+1;
		$filename_title = 'VTS_DAILYREPORT_EXPERTGROUP_'.$previous_date."_".$inc_serial;
  ...
  $to = 'pradeepprotect@gmail.com'; 
  //$to = 'tanveerdad@gmail.com'; 
  $subject = 'VTS_REPORT_EXPERTGROUP_'.$previous_date;
  $message = 'VTS_REPORT_EXPERTGROUP_'.$previous_date; 
