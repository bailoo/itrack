...
{	
	...
	{  	
		...
		if($base_station_name_temp!="")
		{
		  ...
		  for($j=0;$j<sizeof($departure_time);$j++)
		  {
			...
			if($departure_time[$j]=="")
			  $departure_time[$j] = "No StartTime found";
			
			$trip_departure_time[] = $departure_time[$j];
			
			if($arrival_time[$j]=="")
			  $arrival_time[$j] = "No StopTime found";
		  ...
		  if(sizeof($departure_time)==0 && sizeof($arrival_time)==0)
		  {
			$trip_vname[] = $vname[$i];
			$base_station_name[] = $base_station_name_temp;
			$trip_departure_time[] = "No StartTime found";
			$trip_arrival_time[] = "No StopTime found";        
		  }
		}                
	}   
  ...
  $headers .= "Cc: tanveerdad@gmail.com,jyoti.jaiswal@iembsys.com";
