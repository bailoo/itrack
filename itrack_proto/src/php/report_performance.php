<?php
    ...
    <table border=0 width = 100% cellspacing=2 cellpadding=0>
  		<tr>
  			<td height=10 class="report_heading" align="center">Performance Report</td>
  		</tr>
  	</table>    
   ...
   // echo '<option value="10">10 min</option>';
    ...
    <br>  
	  <center>
    <SPAN STYLE="font-size: xx-small"><input type="checkbox" id="filter_flag" checked>&nbsp;Filter Zero Distance Record    					  
      </center>
    </SPAN>
    <br>
    </td>
		...
		<table border=0 cellspacing=0 cellpadding=3 align="center">						
			...
			<tr>
				<td align="center" colspan=2>
					<input type="button" onclick="javascript:action_report_performance(this.form);" value="Enter">
						&nbsp;
