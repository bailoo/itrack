 ...
 echo'
  <center>
			<table border=0 width = 100% cellspacing=2 cellpadding=0>
				<tr>
					<td height=10 class="report_heading" align="center">Speed violation</td>
				</tr>
			</table>			
			...
			<table border=0 cellspacing=0 cellpadding=3 align="center">						
				...
				<tr>
					<td align="center" colspan=2>
						<input type="button" onclick="javascript:action_alert_speed_violation(this.form);" value="Enter">
							&nbsp;
