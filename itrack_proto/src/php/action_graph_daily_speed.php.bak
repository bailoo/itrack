...
<?php   
	$speedData= VTSVehicleData::getSpeedData($DbConnection, $vehicle_id, $startDateTime, $endDateTime); 
  ...
  echo '<div style="height:5px;"></div>
        <center>
          ...
          <table>
              <tr>
                <td>
                    <b><font size=2><b>Speed Graph</font></b>
                </td>
              </tr>
            </table>
            ...
            <table align="center" border=0 cellpadding="3" cellspacing="2">
              <tr>                
                ...
                <td>
                  <input type="button" onclick="javascript:action_graph_daily_speed(this.form);" value="Update">&nbsp;
                </td>
              </tr>
            </table>
          </center>
