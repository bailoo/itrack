<?php
	...
	if($shift1 == "1")
	{
		...
		$data = getDetailAllRouteAssingment2($account_id,$DbConnection);
	}
	else if($shift1 == "2")
	{
		//echo "MORNING SHIFT";
		$shift_name = "Morning Shift";		
		$data = getDetailAllRouteAssingment3($account_id,$DbConnection);
	}
	...
	foreach($data as $dt)
	{
		$vname_assigned[] = $dt['vname_assigned'];
		$route_assigned[] = $dt['route_assigned'];
		$remark_assigned[] = $dt['remark_assigned'];
	}
