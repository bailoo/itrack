...
function moto_show_vehicle(action_no)
 ...
 {
	//alert("clicked:vname="+vehicle_name);
  //var poststr ="vehicleid_to_location="+vehicle_id+"&vehicle_name="+vehicle_name;
...
{       
        if(action_type=="add")
       {
            ...
            if(result!=false)
            {
                ...
                else if(document.getElementById("from_place").value=="") 
                {
                  alert("Please Enter From Place Name");
                  document.getElementById("from_place").focus();
                  return false;
                }
                 else if(document.getElementById("to_place").value=="") 
                {
                  alert("Please Enter To Place Name");
                  document.getElementById("to_place").focus();
                  return false;
                }
                else if(document.getElementById("consignee_name").value=="") 
                {
...
{		
   ...
   function action_manage_device_sale(obj, action_type)
   {
	...
	function vehicle_validation(action_type)
	{
		...
		if(action_type1[0]=='add')
		{		
			var sim_number=document.getElementById('sim_number').value;
			if((isNaN(sim_number)) || (sim_number==""))
			{alert("Enter valid Sim Number!");document.getElementById('sim_number').focus();return false;}
		
			var mobile_number=document.getElementById('mobile_number').value;
			if((isNaN(mobile_number)) || (mobile_number==""))
			{alert("Enter valid Mobile Number!");document.getElementById('mobile_number').focus();return false;}
		}
   ...
   {
     makePOSTRequest('src/php/manage_add_assign.htm', '');
   }
   ...
   function show_add_assign_res(obj)
   {
      ...
      makePOSTRequest('src/php/action_manage_add_assign.htm', poststr);
   }*/
...
var add_station_no=document.getElementById("add_station_no").value;   	    
    ...
    {
  		//alert("document.manage1="+document.manage1);
  		//alert("abc_val="+document.manage1.abc.value);  		
  ...
  function action_manage_expense_type(action_type)
{
    ...
    //alert("poststr="+poststr);
    makePOSTRequest('src/php/action_manage_expense_type.htm', poststr);    
}
...
function action_manage_expense(action_type)
	{
		...
		//alert("poststr="+poststr);
		makePOSTRequest('src/php/action_manage_expense.htm', poststr);		
	}
...
function action_manage_call_type(action_type)
{
    ...
    //alert("poststr="+poststr);
    makePOSTRequest('src/php/action_manage_call_type.htm', poststr);    
}
...
function action_manage_call_detail(action_type)
	{
		...
		//alert("poststr="+poststr);
		makePOSTRequest('src/php/action_manage_call_detail.htm', poststr);		
	}
	...
	function action_manage_sales_route(action_type)
	{
		...
		//alert("poststr="+poststr);
		makePOSTRequest('src/php/action_manage_sales_route.htm', poststr);		
	}
	...
	function action_manage_add_day_plan(action_type)
	{
		...
		//alert("poststr="+poststr);
		makePOSTRequest('src/php/action_manage_add_day_plan.htm', poststr);		
	}
 ...
 {   
  ...
  {     
   ...
   //alert(poststr);
    makePOSTRequest('src/php/action_manage_order.htm', poststr);        
  }
  ...
  {  
	...
	for(var i=1;i<=item_count;i++)
	{
		...
		//alert("poststr="+poststr);
		makePOSTRequest('src/php/manage_invoice_format.htm', poststr);    
 }
...
/////////////////////////////////////////////stop sales ///////////////////
 ...
 function assigned_alert_info(escalation_id)
 {
  ...
  makePOSTRequest('src/php/manage_ajax_escalation.htm', poststr);
 }
 */
 //////////// ESCALATION CLOSED ///////
 ...
 function action_manage_landmark(action_type)
 {
	...
	/*function landmark_form_validation(landmark_name,landmark_point,zoom_level,distance_variable)
	{
		...
		{
			if(parseFloat(distance_variable)>10.0)
			{
				alert("Distance Variable can not be more than 10 km.Please Enter it below 10 km.");
				document.getElementById("distance_variable").focus();
				return false;
			}
		}	
...
//===========End of taseen updation=============================================================//
 function action_manage_school(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_school.htm', poststr);
 }
...
if(action_type=="assign")
		{
			...
			var file_name="src/php/action_manage_student.htm";						
		}
 ...
 function action_manage_studentcard(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_studentcard.htm', poststr);
 } 
  function action_manage_busdriver(action_type)
 {
  //alert("busdriver");
    ...
    makePOSTRequest('src/php/action_manage_busdriver.htm', poststr);
 }
  function action_manage_bus(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_bus.htm', poststr);
 }
...
function action_manage_escalation_school(action_type)
  {  
   ...
   // alert(result);
	...
	//-------end of delete----------//
    alert("welcome");
    makePOSTRequest('src/php/action_manage_escalation_school.htm', poststr);
  }
///////////////////////////////////////////
 ...
 function action_manage_busstop(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_busstop.htm', poststr);
 }
...
// function for string of bus stop serials
  ...
  function action_manage_busroute(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_busroute.htm', poststr);
 } 
 ...
 function action_manage_shift(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_shift.htm', poststr);
 }
 ...
 function action_manage_person(action_type)
 {
    ...
    makePOSTRequest('src/php/action_manage_person.htm', poststr);
 } 
...
function action_manage_visit(action_type)
{
  ...
  if(action_type=="getlocations")  
    ...
    makePOSTRequest('src/php/action_manage_visit.htm', poststr);
 } 
