...
{		
    ...
    if(type == "1")
    {
      ...
      var strURL="ajax_update_station.php?station_id="+station_id+"&station_name="+station_name+"&customer_no="+customer_no+"&type=1";	
      //alert("s1="+strURL);  
  		var req = getXMLHTTP();
    ...
    {
      var strURL="ajax_update_station.php?station_id="+station_id+"&type=2";	
      //alert("s2="+strURL);    
  		var req = getXMLHTTP();
  		req.open("GET", strURL, false); //third parameter is set to false here
  		req.send(null);
