       ...
       if (http_request.status == 200) 
       {
		 ...
		 else if(result1[0].trim()=="filename_fields")
		 {
		   ...
		   else if(result1[0]=="vendor_account_edit")
          {
			...
			else if(result1[0]=="display_combo")
            { 
				//alert("res="+result1[0]);
...
/////////////stop sales ///////////////////		
          ...
          else if(result1[0]=="calibration_detail")
          {
            //alert("result1="+result1[1]+"result2="+result1[2]);
            document.getElementById("calibration_area").style.display="";  /////////for enabling coord input type in Existing option
            document.getElementById('calibration_name').value=result1[1];
            document.getElementById('calibration_data').value=result1[2];           
          }
          else if(result1[0]=="escalation_detail")
          {
            //alert("result1="+result1[1]+"result2="+result1[2]);
            ...
            document.getElementById('other_detail').value=result1[3];           
          }
          ...
          else if(result1[0]=="alert_assign")
          {
			      //alert("landmark="+result1[1]+"lanmark_point="+result1[2]+"zoom_level="+result1[3]);
          ...
          else if(result1[0]=="add" || result1[0]=="assign" || result1[0]=="register" || result1[0]=="edit" || result1[0]=="deassign" || result1[0]=="de-register" || result1[0]=="choose_account")
          {
          ...
          else if(result1[0]=="edit_div_station1")
          {
          ...
          else if(result1[0]=="edit_div_station2")
          {
          ...
          else if(result1[0]=="map_show_vehicle" || result1[0]=="live_show_vehicle")
          {
 ...
 /*         $school_id1=$row->school_id;
          ...
          else if(result1[0]=="search_vehicle")
    	  {
    			document.getElementById("box").innerHTML =  result1[1];
          }  
          else if(result1[0]=="search_vehicle1")
    	  {
				//alert("veh_name="+result1[2]);
				var tempppp=trim(result1[1]+"box");
				//alert("tempppp="+tempppp);
				document.getElementById(tempppp).innerHTML =  result1[2];					
    	  }
          else if(result1[0]=="search_vehicle2")
    	  {
				//alert("veh_name="+result1[2]);
