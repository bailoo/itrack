...
include_once($abspath."/daily_report/motherdairy/pdu/get_master_detail.php");
...
$startdate = $date." 00:00:00";               //TIME 6AM TO 10AM
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_(MOTHER_PDU)_'.$previous_date."_".$inc_serial;
...
*/	
	...
	########### SEND MAIL ##############//
	$to = 'Praveen.Chamoli@motherdairy.com,Trilok1.Singh@motherdairy.com,narender1.singh@motherdairy.com';
	//$to = 'jyoti.jaiswal@iembsys.com';
	$subject = 'BETA::VTS_HALT_REPORT_(MOTHER_PDU)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_(MOTHER_PDU)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply to this email***</font>"; 
