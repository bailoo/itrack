...
$startdate = $current_date." 09:00:00";               //ZPME……..9am to 7pm (same date)
$enddate = $current_date." 19:00:00"; 
/////////////////////////////////////////
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_EVENING_(MOTHER_MUMBAI)_'.$previous_date."_".$inc_serial;
	...
	$to = 'Logistics.Vashi@motherdairy.com, Anand.Arondekar@motherdairy.com, Vijay.Singh@motherdairy.com, ashish@iembsys.co.in';

	$subject = 'BETA::VTS_HALT_REPORT_EVENING_(MOTHER_MUMBAI)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_EVENING_(MOTHER_MUMBAI)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply to this email***</font>"; 
