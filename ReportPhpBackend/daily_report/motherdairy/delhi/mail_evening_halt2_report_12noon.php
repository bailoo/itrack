...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_EVENING2_(MOTHER_DELHI)_'.$previous_date."_".$inc_serial."#ev2";
...
//	$to = 'Vijay.Singh@motherdairy.com,teetu.kumar@motherdairy.com,call1.center@motherdairy.com,ashish.sawhney@motherdairy.com,Rahul.tiwari@motherdairy.com,Shiv.sharma@motherdairy.com,Logistic.Ppg@motherdairy.com,ashish@iembsys.co.in,jitendra3.kumar@motherdairy.com';
	...
	$subject = 'BETA::VTS_HALT_REPORT_EVENING2_(MOTHER_DELHI)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_EVENING2_(MOTHER_DELHI)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>";; 
