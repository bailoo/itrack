...
function get_customer_db_detail($account_id, $shift_time, $route_type_param)
{
	...
	if($shift_time=="ZBVM")
	{
		...
		if($DEBUG_OFFLINE)
		{
			$path = "D:\\test_app/gps_report/".$account_id."/master/morning_plant_customer#1#12.csv";			
		}
		else
		{
	...
	else if($shift_time=="ZBVE")
	{
		...
		if($DEBUG_OFFLINE)
		{
			$path = "D:\\test_app/gps_report/".$account_id."/master/evening_plant_customer#1#11.csv";
		}
		else
		{
