<?php
function create_violated_hrly_excel($read_excel_path)
{
	...
	*/	
	...
	if($msg_bs_tmp!="")
	{	
		$message.= '<TABLE BORDER=1 CELLPADDING=3 CELLSPACING=1 RULES=ROWS FRAME=BOX><TR><TD align="left" colspan="6" style="color:black;font-size:17px;font-weight:bold;">*BASE LOCATION DEPARTURE VIOLATION</TD></TR>';
		$message.= $msg_bs_tmp;
		$message.= 	'</TABLE>';			
	}
	...
	{		
		$message.= '<TABLE BORDER=1 CELLPADDING=3 CELLSPACING=1 RULES=ROWS FRAME=BOX><TR><TD align="left" colspan="3" style="color:black;font-size:17px;font-weight:bold;">*VILLAGE ROUTE VIOLATION ALERT</TD></TR>';
		$message.= $village_violate_msg;
		$message.= '</TABLE>';
	}
