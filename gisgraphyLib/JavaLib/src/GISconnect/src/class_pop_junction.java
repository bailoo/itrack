...
public class class_pop_junction {
	...
	//========pop by lat lng
	class_pop_junction(String lt, String lg){
		lat=lt;
		lng=lg;
	...
	//========pop by latlng array
	class_pop_junction(ArrayList<LatLng> latlngArray,int radius){
	...
	//========pop by code array
	class_pop_junction(ArrayList<LatLng> codeArray){
