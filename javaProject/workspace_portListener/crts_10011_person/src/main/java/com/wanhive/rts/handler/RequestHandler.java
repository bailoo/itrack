...
//		String RealDataPath = "D:\\itrack_vts/last_location";
			...
			{				
				...
				for(k=0;k<NoofToken;k++)
				{
					...
					//if(NoofField > 4)
					{
						...
						//MsgType,Imei,Devicetime,Lat,Lng,StartStatus,Cellid,MCC,MNC,ver
						...
						if( (valid_imei) && ((data[0].equals("NORMAL")) || (data[0].equals("PWRSV")) || (data[0].equals("LOD")) || (data[0].equals("ALERT")) || (data[0].equals("LOD")) || (data[0].equals("GPS")) || (data[0].equals("PDU")) || (data[0].equals("GPS-HALT")) || (data[0].equals("GPS-START"))) )
						{
							...
							MsgType = data[0];
							DeviceIMEINo = data[1];
							devicedatetime = data[2];
							Latitude = data[3];
							Longitude =  data[4];
							Version = data[9];
							Fix = "1";						
							CellName=data[6]+","+data[7]+","+data[8]+","+data[5];
							Altitude = "0.0";
							Speed = "0.0";
							...
							String q="\"";							
							 ...
							 try{
									 ...
									 marker_a2 = MsgType+q+Version+q+Fix+q+Latitude+q+Longitude+q+speed_f+q+CellName+q; 		//without cellname
							...
							try{	
								...
								write_last_location(MsgType,vserial,Version,Fix,Latitude,Longitude,Speed,serverdatetime,DateTime,CellName);
	...
	public void write_last_location(String MsgType, String imei, String Version, String Fix, String Latitude, String Longitude, String Speed, String serverdatetime, String DateTime, String CellName) 
	{	
			...
			//if ( (curr_device_millis - last_device_millis > 60000) && (curr_device_millis - server_millis  < 600000) ){  //about 10 min			
				...
				if(!record_exist) {
					...
					if( (!Latitude.equals("")) && (!Longitude.equals("")) && (!Latitude.equals("0.0")) && (!Longitude.equals("0.0")) ) {
						...
						line = MsgType+q+Version+q+Fix+q+Latitude+q+Longitude+q+Speed+q+DateTime+q+CellName+q;
