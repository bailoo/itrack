...
//		String RealDataPath = "D:\\itrack_vts/last_location";
				...
				for(k=0;k<NoofToken ;k++)
				{
					...
					//if(NoofField > 4)
					{
						...
						if( (valid_imei) && ((data[0].equals("NORMAL")) || (data[0].equals("PWRSV")) || (data[0].equals("LOD")) || (data[0].equals("ALERT")) || (data[0].equals("LOD")) || (data[0].equals("GPS")) || (data[0].equals("PDU")) || (data[0].equals("GPS-HALT")) || (data[0].equals("GPS-START"))) )
						{
							...
							/*ln_io_value1 = Double.parseDouble(io_value1);
							ln_io_value2 = Double.parseDouble(io_value2);
							ln_io_value3 = Double.parseDouble(io_value3);
							ln_io_value4 = Double.parseDouble(io_value4);
							ln_io_value5 = Double.parseDouble(io_value5);
							ln_io_value6 = Double.parseDouble(io_value6);
							ln_io_value7 = Double.parseDouble(io_value7);
							ln_io_value8 = Double.parseDouble(io_value8);		
							
							if(ln_io_value1 > 5000)
							{
								ln_io_value1 = 0;
							}
							if(ln_io_value2 > 5000)
							{
								ln_io_value2 = 0;
							}
							if(ln_io_value3 > 5000)
							{
								ln_io_value3 = 0;
							}
							if(ln_io_value4 > 5000)
							{
								ln_io_value4 = 0;
							}
							if(ln_io_value5 > 5000)
							{
								ln_io_value5 = 0;
							}
							if(ln_io_value6 > 5000)
							{
								ln_io_value6 = 0;
							}
							if(ln_io_value7 > 5000)
							{
								ln_io_value7 = 0;
							}
							if(ln_io_value8 > 5000)
							{
								ln_io_value8 = 0;
							}*/							
							...
							//////////////////////// DATA[7] SupplyVoltage CLOSED//////////              							
							/*SpeedAlert = Integer.parseInt(data[23]);
							GeofenceInAlert = Integer.parseInt(data[24]);
							GeofenceOutAlert = Integer.parseInt(data[25]);
							StopAlert = Integer.parseInt(data[26]);
							MoveAlert = Integer.parseInt(data[27]);
							LowVoltageAlert = Integer.parseInt(data[28]);*/											
						...
						//	FileWriteHandler CurrentFileWriteHandler = null;
							 ...
							 try{
								 ...
								 //{
									...
									//System.out.println("File Length1="+length1);									
									 ...
									 marker_a2 = MsgType+q+Version+q+Fix+q+Latitude+q+Longitude+q+speed_f+q+io_value1+q+io_value2+q+io_value3+q+io_value4+q+io_value5+q+io_value6+q+io_value7+q+io_value8+q+Signal_Strength+q+supv_f+q+CellName+q+ax+q+ay+q+az+q+mx+q+my+q+mz+q+bx+q+by+q+bz+q; 		//without cellname
									 //System.out.println("Before:"+DateTime);
									 TransactionServer.push_cassandra.insertFulldata(DeviceIMEINo,DateTime,marker_a2);									 //TransactionServer.push_cassandra.insertLastdata(DeviceIMEINo, marker_a2);
							...
							try{	
								...
								write_last_location(MsgType,vserial,Version,Fix,Latitude,Longitude,Speed,serverdatetime,DateTime,io_value1,io_value2,io_value3,io_value4,io_value5,io_value6,io_value7,io_value8,Signal_Strength,SupplyVoltage,CellName,ax,ay,az,mx,my,my,bx,by,bz);
	...
	public void write_last_location(String MsgType, String imei, String Version, String Fix, String Latitude, String Longitude, String Speed, String serverdatetime, String DateTime, String io_value1, String io_value2, String io_value3, String io_value4, String io_value5, String io_value6, String io_value7, String io_value8, String Signal_Strength, String SupplyVoltage,String cellname,String ax,String ay,String az,String mx, String my, String mz,String bx, String by, String bz) {
			...
			if( (!Latitude.equals("")) && (!Longitude.equals("")) && (!Latitude.equals("0.0")) && (!Longitude.equals("0.0")) ) 
			{
				if(TransactionServer.last_update_time.get(imei)==null) 
				{
		...
		
					{
						...
						line = MsgType+q+Version+q+Fix+q+Latitude+q+Longitude+q+Speed+q+DateTime+q+io_value1+q+io_value2+q+io_value3+q+io_value4+q+io_value5+q+io_value6+q+io_value7+q+io_value8+q+Signal_Strength+q+SupplyVoltage+q+day_max_speed+q+day_max_speed_time+q+last_halt_time+q+cellname+q+ax+q+ay+q+az+q+mx+q+my+q+mz+q+bx+q+by+q+bz+q;
