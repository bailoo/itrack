...
//		String RealDataPath = "D:\\itrack_vts/last_location";
							 ...
							 try{
								 ...
								 //{
									...
									//System.out.println("File Length1="+length1);									
									 ...
									 //TransactionServer.push_cassandra.insertLastdata(DeviceIMEINo, marker_a2);
						//			 System.out.println("After");
									 //TransactionServer.st_cassandra.insertLastdata(DeviceIMEINo,marker_a2);
	...
	public void write_last_location(String MsgType, String imei, String Version, String Fix, String Latitude, String Longitude, String Speed, String serverdatetime, String DateTime, String io_value1, String io_value2, String io_value3, String io_value4, String io_value5, String io_value6, String io_value7, String io_value8, String Signal_Strength, String SupplyVoltage,String cellname) {
		...
		try {				
			/*System.out.println("LastUpdateTime="+TransactionServer.last_update_time.get(vserial));
			...
			if ( (curr_device_millis - last_device_millis > 60000) && (server_millis - curr_device_millis < 600000) ){  //about 10 min
				...
				//########## BLANK FILE CLOSED		
					...
					if(cass_day_max_speed.equals("")) {
						cass_day_max_speed = "0.0";
					}
					if(Speed.equals("")) {
						Speed = "0.0";
					}
					if(cass_day_max_speed_time.equals("")) {
						cass_day_max_speed_time = DateTime;
					}						
					//############################
					...
					if(  (date_last_loc2.compareTo(date_last_loc1) > 0) && (!Latitude.equals("")) && (!Longitude.equals("")) && (!Latitude.equals("0.0")) && (!Longitude.equals("0.0")) ) {																  
