...
public class read_exception_timing_input {

	//#### READ CSV
	public static void readCSVFile(String file_path, alert_variables av) throws IOException {	
		 //String writeString = "";		
		 ...
		 try{
			  ...
			  while ((strLine = br.readLine()) != null) {
				...
				{  
					...
					//CUSTOMER TIME
					String[] time_a3 = customer_time.split(":");
					int tmp_hr3_int = Integer.parseInt(time_a3[0]);
					int tmp_min3_int = Integer.parseInt(time_a3[1]);
					int tmp_sec3_int = Integer.parseInt(time_a3[2]);
							        
					String tmp_hr3="",tmp_min3="",tmp_sec3="";
					
					if(tmp_hr3_int < 10)
					{
					  tmp_hr3 = "0"+tmp_hr3_int;
					}
					else
					{
						tmp_hr3 = ""+tmp_hr3_int;
					...
					if(tmp_min3_int < 10)
					{
					  tmp_min3 = "0"+tmp_min3_int;
					}
					else
					{
						tmp_min3 = ""+tmp_min3_int;
					}
					if(tmp_sec3_int < 10)
					{
					  tmp_sec3 = "0"+tmp_sec3_int;
					}
					else
					{
						tmp_sec3 = ""+tmp_sec3_int;
					}	
					String time_str3 = tmp_hr3+":"+tmp_min3+":"+tmp_sec3;	
		  			///////////////////////////////////////////////////////////////////// 			
	...
	/*
	public static void readXLSFile1(String file_path, alert_variables av) throws IOException {
	...
	//#### READ XLS
	public static void readXLSFile(String file_path, alert_variables av) throws IOException {
				...
				else
				{
					...
					//echo "In Else=".$data[$c] . "<br />\n";		  									
						...
						else if(c==4)
						{
							...
							{						
								...
								if (DateUtil.isCellDateFormatted(cell)) 
								{
									...
									SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
									//SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
									customer_time = formatter.format(time1tmp);
									//System.out.println("C1TIME====="+time1);										
								} 
								break;
								default:
						...
						else if(c==5)
						{
						  ...
						  //System.out.println("c5="+customer_no1);					  
						}							
					} //ELSE CLOSED				  
	...
	//###### READ XLSX
	public static void readXLSXFile(String file_path, alert_variables av) throws IOException
	{
		...
		while (rows.hasNext())
		{
					  ...
					  //time2 = record;
						...
						{						
							...
							if (DateUtil.isCellDateFormatted(cell)) 
							{
								...
								SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
								//SimpleDateFormat formatter = new SimpleDateFormat("HH:mm:ss");
								customer_time1 = formatter.format(time1tmp);
								//System.out.println("C1TIME====="+time1);										
							} 
							break;
							default:
						...
						//System.out.println("Row="+r+" ,Col="+c+" ,customer_time="+customer_time);
					}                 								
					else if(c==5)
					{
					  //customer_no1 = intval(record);
			...
			if(customer_no1 >0)
			{  
				//System.out.println("Row="+r+" ,Col="+c+" ,customer_time="+customer_time1);
				//System.out.println("CT1="+customer_time1);
				///////////MAKE INDIVIDUAL START DATE AND END DATE//////////					        
				//DATE
				...
				//CUSTOMER TIME					
				//System.out.println("CT2="+customer_time1);
				String[] time_a3 = customer_time1.split(":");
				int tmp_hr3_int = Integer.parseInt(time_a3[0]);
				int tmp_min3_int = Integer.parseInt(time_a3[1]);
				int tmp_sec3_int = Integer.parseInt(time_a3[2]);
