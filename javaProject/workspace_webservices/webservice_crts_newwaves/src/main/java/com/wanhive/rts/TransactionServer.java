...
//	public static String RealDataPath = "D:\\itrack_vts/last_location";
	...
	static final String DB_URL = "jdbc:mysql://"+host+"/iespl_vts_beta";	//public static final String DB_URL_remote = "jdbc:mysql://localhost/iespl_vts_beta";
	...
	public static final String USER = "bailoo";
	public static final String PASS = "neon04$VTS";	
...
//		Application.writeLog("TransactionServer[run]: SHUTDOWN COMPLETE", SystemLogger.WARN);
	...
	{		
		...
		try{
			...
			ResultSet rs_remote = stmt.executeQuery(sql);
		    while(rs_remote.next()){
		         ...
		         }catch(SQLException sq) {System.out.println("Error in gpsvendor db");}
		    }
