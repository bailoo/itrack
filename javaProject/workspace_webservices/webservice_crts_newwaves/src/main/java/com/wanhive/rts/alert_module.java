   ...
   public static double deg2rad(double deg) {
	...
	public static void push_sms_alert_to_database(int account_id,String vehicle_name,String imei_no,String ph_no,String message,String message_type,String sts)
	{
	   ...
	   try{
	      ...
	      String sql;
	      sql = "INSERT INTO sms_log(account_id,vehicle_name,imei_no,ph_no,message,message_type,status,remarks,create_date) "+
	      "values('"+account_id+"','"+vehicle_name+"','"+imei_no+"','"+ph_no+"','"+message+"','"+message_type+"',1,'-','"+sts+"')";
	...
	public static void push_email_alert_to_database(int account_id,String vehicle_name,String imei_no,String email,String message,String message_type,String sts, String subject)
	{
		   ...
		   try{
		      ...
		      String sql;
		      sql = "INSERT INTO sms_log(account_id,vehicle_name,imei_no,email,message,message_type,status,remarks,create_date) "+
		      "values('"+account_id+"','"+vehicle_name+"','"+imei_no+"','"+email+"','"+subject+"','"+message+"','"+message_type+"',1,'-','"+sts+"')";
		      System.out.println(sql);
		      stmt.executeUpdate(sql);
	...
	{
		try {		
				String Request = "http://www.itracksolution.com/src/php/get_url_location2.php?lat="+lat+"&lng="+lng+"";
	      ...
	      while(rs.next()){
	         ...
	         try{
				...
				//{										
					...
					System.out.println("date:"+rs.getString("trip_startdate"));
					String[] tmp_sd = rs.getString("trip_startdate").split("\\.");
					System.out.println("TripStartDate="+tmp_sd[0]);
					alert_variables.trip_startdate.put(imei, tmp_sd[0]);
