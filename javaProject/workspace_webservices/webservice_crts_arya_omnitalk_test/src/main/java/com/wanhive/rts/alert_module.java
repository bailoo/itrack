...
public class alert_module {
   ...
   static final String DB_URL = "jdbc:mysql://"+host+"/alert_session";
	    ...
	    //###### Remove Imei which Trip status =0	      
	      while(rs.next()){
	         ...
	         try{
				...
				//System.out.println("trip_status=1"+imei);				
				...
				{										
					...
					alert_variables.trip_startdate.put(imei, rs.getString("trip_startdate"));
					alert_variables.trip_status.put(imei, trip_status);
