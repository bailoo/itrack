...
//	public static String RealDataPath = "D:\\itrack_vts/last_location";
	...
	//###### SET TRANSACTION IDS
	public static final int vendor_sno = 5;	
	public static final int gps_vendor_id = 10;
	//################
			...
			try{
				for(String vehicleNoString : vehicleNoArr) {
					...
					if( (LastTime.get(vehicleNoString)==null) || (LastTime.get(vehicleNoString).equals("")) || (LastTime.get(vehicleNoString).equals("null"))) {
						...
						sd_tmp = null;
						try {
							sd_tmp = dDF.parse(LastTime.get(vehicleNoString));
						} catch (ParseException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						}
						...
						cal1.setTime(sd_tmp);
						startdate1 = inputDateFormat.format(cal1.getTime());						
						//startdate1 = LastTime.get(vehicleNoString);
					}					
					//System.out.println("startdate1="+startdate1);
					String vehicle_str = "%27"+vehicleNoString+"%27";
		        	...
		        	String Request = "http://webservice.noviretechnologies.com/ws3/rest/controller/services/%7Bmethod:%22ref_RealTimeDataFetch%22,username:%22esquire_user%22,password:%22welcome%22%7D/%7Bfrom_dateTime:%22"+startdate1+"%22,to_dateTime:%22"+enddate1+"%22,vehicles:%22"+vehicle_str+"%22%7D";		        	
		            ...
		            while(null != (strTemp = br.readLine())){
			        	...
			        	String[]token1 = strTemp.split("],");
			        	String part1 = token1[0];
			        	//System.out.println("part1="+part1);
			        	String[]token2 = part1.split("\\:\\[");
			        	//System.out.println("Token2="+token2[1]);
			        	String partfinal = "["+token2[1]+"]";
			        	strTemp = partfinal;
			        	//System.out.println("StrTempF="+strTemp);
			     			        	
			        	try{
			        		//String reader = "[{\"IMEINo\":\"123\",\"Speed\":30},{\"IMEINo\":\"456\",\"Speed\":40}]";
			        		JSONArray jArray = new JSONArray(strTemp);
			        		//System.out.println("Data2:"+strTemp);   
			        		...
			        		for(int i = 0 ; i <jArray.length();i++){
			        			...
			        			try{
				        			...
				        			//System.out.println("D1="+DateTime+" ,DeviceIMEINo="+DeviceIMEINo);
