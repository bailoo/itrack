...
public class push_device_data {
	...
	/*public void insertFulldata(String imei, String data, String device_time){
		...
		System.out.println("Pushing Full data to cassandra");
		...
		//imei += "@2015-01-29@00";
		try{
		String dtbin[] = device_time.split(" ");
		String hrbin[] = dtbin[1].split(":");
		imei += "@"+dtbin[0]+"@"+hrbin[0];
		}catch(Exception dt) {System.out.println(dt.getMessage());}
		
		Date dtObj = new Date();	
		try { 
			dtObj = sdf.parse(device_time);
		}
		catch (Exception e) {
			e.printStackTrace();
		}		
		FullData fullData = new FullData(imei, dtObj, now.getTime(), data);
	...
	/*public void insertLastdata(String imei, String day, String data){
		...
		data = "N;v1.45C;1;26.25148;79.86157;0.06;2015-01-29@00:00:09;2015-01-29@00:00:09;2;5;3;5;6;6;3;5;0;12.88";
	...
	/*public static void main(String[] args) {
		...
		push_device_data st = new push_device_data();
