...
function get_route_db_detail($shift)
{
	...
	{
		//echo "EV:".$query;		  
		$query = "SELECT DISTINCT route_assignment2.vehicle_name,route_assignment2.route_name_ev FROM route_assignment2,vehicle WHERE route_assignment2.user_account_id='$account_id' AND NOT(route_assignment2.route_name_ev='') AND route_assignment2.vehicle_name=vehicle.vehicle_name AND route_assignment2.status=1 AND route_assignment2.vehicle_name='HR46D7324' Order By route_assignment2.route_name_ev DESC";
