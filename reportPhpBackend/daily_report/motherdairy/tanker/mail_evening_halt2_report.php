...
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
                    "vehicle.vehicle_id = vehicle_assignment.vehicle_id AND vehicle_assignment.vehicle_id = vehicle_grouping.vehicle_id AND ".
                    "vehicle_grouping.account_id='$account_id' AND vehicle.status=1 AND vehicle_assignment.status=1 AND vehicle_grouping.status=1 and vehicle.vehicle_id IN(2620,1217)";					
*/
/*
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
                    "vehicle.vehicle_id = vehicle_assignment.vehicle_id AND vehicle_assignment.vehicle_id = vehicle_grouping.vehicle_id AND ".
...
//$previous_date = '2013-10-31';	//TEMPORARY VARIABLES-DELETE
//$current_date = '2013-11-01';
//////////////////////////////////////////
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_EVENING_(MOTHER_TANKER)_'.$previous_date."_".$inc_serial;
  ...
  //echo "\nWORKBOOK CLOSED"; 
	...
	$subject = 'BETA::VTS_HALT_REPORT_EVENING_(MOTHER_TANKER)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_EVENING_(MOTHER_TANKER)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>";; 
