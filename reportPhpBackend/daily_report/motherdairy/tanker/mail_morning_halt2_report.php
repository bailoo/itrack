...
include_once($abspath."/daily_report/motherdairy/tanker/get_master_detail.php");
...
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
"vehicle.vehicle_id = vehicle_assignment.vehicle_id AND vehicle_assignment.vehicle_id = vehicle_grouping.vehicle_id AND ".
"vehicle_grouping.account_id='$account_id' AND vehicle.status=1 AND vehicle_assignment.status=1 AND vehicle_grouping.status=1 limit 2";   
*/
...
//$current_date ='2013-11-02';	//TEMPORARY DELETE
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_MORNING_(MOTHER_TANKER)_'.$current_date."_".$inc_serial;
	...
	$to = 'Amit.Patel@motherdairy.com,Vijay.Singh@motherdairy.com,kapil.dhaka@motherdairy.com,ashish@iembsys.co.in,vivek.chahal@motherdairy.com';
	$subject = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_TANKER)_'.$current_date;
	$message = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_TANKER)_'.$current_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply ***</font>"; 
