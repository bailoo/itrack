...
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
                    "vehicle.vehicle_id = vehicle_assignment.vehicle_id AND vehicle_assignment.vehicle_id = vehicle_grouping.vehicle_id AND ".
                    "vehicle_grouping.account_id='$account_id' AND vehicle.status=1 AND vehicle_assignment.status=1 AND vehicle_grouping.status=1 and vehicle.vehicle_id IN(2620,2684)";					


/*
$query_assignment = "SELECT DISTINCT vehicle.vehicle_id,vehicle.vehicle_name FROM vehicle,vehicle_assignment,vehicle_grouping WHERE ".
                    "vehicle.vehicle_id = vehicle_assignment.vehicle_id AND vehicle_assignment.vehicle_id = vehicle_grouping.vehicle_id AND ".
                    "vehicle_grouping.account_id='$account_id' AND vehicle.status=1 AND vehicle_assignment.status=1 AND vehicle_grouping.status=1 limit 1";					
*/
...
//////////////////////////////////////////
$startdate = $previous_date." 15:00:00";               //TIME 3PM TO 6AM
$enddate = $current_date." 06:00:00"; 
/////////////////////////////////////////

$date1 = $startdate;
$date2 = $enddate;
$user_interval = "2";   //2 MINUTES
...
/*			
$query2 = "SELECT DISTINCT station_id,type,customer_no,station_name,station_coord,distance_variable,google_location FROM station WHERE ".
            "user_account_id='$account_id' AND customer_no IN(865) AND type=0 AND status=1";			
//echo "\nQ1=".$query2;
*/
...
/*			
$query2 = "SELECT DISTINCT station_id,type,customer_no,station_name,station_coord,distance_variable,google_location FROM station WHERE ".
            "user_account_id='$account_id' AND customer_no IN(865) AND type=1 AND status=1";			
//echo "\nQ2=".$query2;*/
$result2 = mysql_query($query2,$DbConnection); 
...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_EVENING_(MOTHER_DELHI)_'.$previous_date."_".$inc_serial;
...
//	$to = 'Shreya.Shinde@motherdairy.com,Vijay.Singh@motherdairy.com,Ravindra.Negi@motherdairy.com,teetu.kumar@motherdairy.com,call1.center@motherdairy.com,ashish@iembsys.co.in';
