...
//if($vehicle_id_final!="")
{
	//$inc_serial=$i+1;
	$inc_serial = rand();
	$filename_title = 'BETA_VTS_HALT_REPORT_MORNING_(MOTHER_BULANDSHAHAR)_'.$previous_date."_".$inc_serial;
    ...
    $worksheet2->write($r, 15, "", $text_format);
    $worksheet2->write($r, 16, "", $text_format);
    /*$worksheet2->write($r, 16, "Transporter(I)", $text_red_format);
	...
	$subject = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_BULANDSHAHAR)_'.$previous_date;
	$message = 'BETA::VTS_HALT_REPORT_MORNING_(MOTHER_BULANDSHAHAR)_'.$previous_date."<br><br><font color=red size=1>*** This is an automatically generated email by the system on specified time, please do not reply to this email***</font>"; 
